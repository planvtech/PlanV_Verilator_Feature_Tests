...
//
// This test validates: virtual interface member trigger behavior
...
module t_vif_class_member();
    ...
    initial begin
        ...
        fork
            begin
                ...
                `DBG(("[%0d]: Write data: %02x", $time, write_intf.data))
                #10ns;
            ...
            begin
                ...
                `DBG(("[%0d]: Got data: %02x", $time, recv_data))
    ...
    // Dump waveforms
    initial begin
        $dumpfile("t_vif_class_member.vcd");
        $dumpvars(0, t_vif_class_member);
    end
