...
//
// This test validates: std::randomize() with inline constraints
...
module t_std_rand_with_basic;
   initial begin
      ...
      if (!(2 < a && a < 7 && b < a)) $stop;
      `DBG(("Test 1 passed: a=%0d, b=%0d", a, b))
      ...
      `DBG(("Test 2 passed: a=%0d, obj.x=%0d (obj.x between a+1 and a+4)", a, obj.x))

      // Test 3: Reference external variable in constraint
      if (std::randomize(a) with { a > 0; a < limit; } != 1) $stop;
      if (!(a > 0 && a < limit)) $stop;
      `DBG(("Test 3 passed: a=%0d, limit=%0d", a, limit))
      ...
      `DBG(("Test 4 passed: obj.x=%0d, obj.y=%0d", obj.x, obj.y))
      ...
      `DBG(("Test 5 passed: a=%0d, obj.x=%0d, obj.y=%0d", a, obj.x, obj.y))
