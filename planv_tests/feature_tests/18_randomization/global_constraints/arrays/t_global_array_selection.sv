...
//
// This test validates: global constraints with array element selection
...
module t_global_array_selection;
    int success;
    Top t;
    ...
    initial begin
        ...
        `DBG(("mids[0].items[1].val=%0d, mids[1].items[2].val=%0d",
                 t.mids[0].items[1].val, t.mids[1].items[2].val))
        `DBG(("sum=%0d, mids[0].items[0].val=%0d, mids[1].items[0].val=%0d",
