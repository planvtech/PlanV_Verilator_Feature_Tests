...
//
// This test validates: rand unpacked array randomization
...
module t_rand_array_unpacked_simple;
  ...
  initial begin
    ...
    if (!my_array.randomize()) begin
      `DBG(("Unpacked array randomization failed."))
      $stop;
    end
    ...
    `DBG(("Unpacked array values:"))
    for (int i = 0; i < 3; i++) begin
      `DBG(("unpacked_array[%0d] = %0d", i, my_array.unpacked_array[i]))
    end
