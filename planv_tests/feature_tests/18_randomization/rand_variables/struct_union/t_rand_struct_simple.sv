...
//
// This test validates: rand struct randomization
...
module t_rand_struct_simple;
    ...
    initial begin
        ...
        repeat(10) begin
            ...
            `DBG(("Packed Struct - byte_value: %h, int_value: %0d", struct_test.packed_struct.byte_value, struct_test.packed_struct.int_value))
            `DBG(("Unpacked Struct - byte_value: %h, int_value: %0d", struct_test.unpacked_struct.byte_value, struct_test.unpacked_struct.int_value))
        end
