...
//
// This test validates: dist constraint for real-valued distributions
...
class real_constraint_c;  
    ...
    constraint a_constraint {
        a dist {
            ...
            [(VALUE_NOM - 0.033):(VALUE_NOM + 0.033)] :/ 13, // equivalent to 3.3 +/- 0.033
...
module t_constraint_dist_real;
    ...
    initial begin
        ...
        `DBG(("a distribution: ZSTATE = %0d, [VALUE_LOW:VALUE_MIN] = %0d, [VALUE_NOM +/- 0.033] = %0d, [VALUE_MIN:VALUE_MAX] = %0d", 
                 a_dist[0], a_dist[1], a_dist[2], a_dist[3]))
        `DBG(("b distribution: ZSTATE = %0d, [VALUE_MIN:VALUE_MAX] = %0d", b_dist[0], b_dist[1]))
