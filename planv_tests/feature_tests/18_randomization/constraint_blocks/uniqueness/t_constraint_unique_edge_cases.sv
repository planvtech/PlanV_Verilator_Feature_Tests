...
//
// This test validates: unique constraint edge cases and complex scenarios
...
class SingleElementArray;
  ...
  function void post_randomize();
    `DBG(("SingleElementArray: single[0] = 0x%h", single[0]))
  endfunction
endclass
...
class TwoElementArray;
  ...
  function void check();
    ...
    `DBG(("TwoElementArray: PASSED - two[0]=0x%h, two[1]=0x%h", two[0], two[1]))
  endfunction
endclass
...
class MultipleUniqueArrays;
  ...
  function void check();
    ...
    if (!pass) $fatal(1, "MultipleUniqueArrays: FAILED");
    `DBG(("MultipleUniqueArrays: PASSED"))
  endfunction
endclass
...
class UniqueWithRange;
  ...
  function void check();
    ...
    if (!pass) $fatal(1, "UniqueWithRange: FAILED");
    `DBG(("UniqueWithRange: PASSED - values: %p", arr))
  endfunction
endclass
...
class LargeArray50;
  ...
  function bit check();
    ...
    `DBG(("LargeArray50: PASSED - 50 unique values generated"))
    return 1;
  endfunction
endclass
...
class LargeArray100;
  ...
  function bit check();
    ...
    `DBG(("LargeArray100: PASSED - 100 unique values generated"))
    return 1;
  endfunction
endclass
...
module t_constraint_unique_edge_cases;
  initial begin
    ...
    `DBG(("=== Test 1: Single Element Array ==="))
    t1 = new();
    ...
    if (t5.randomize()) begin
      ...
      `DBG(("Test 5: PASSED - correctly failed on impossible constraints"))
      success_count++;
    end
    ...
    `DBG(("\n=== SUMMARY ==="))
    `DBG(("Tests passed: %0d/7", success_count))
