// Test if bug occurs with different UVM base classes
// Testing: uvm_test, uvm_env, uvm_agent, uvm_driver, uvm_object
...
package test_components_pkg;
   ...
   class my_object_c extends uvm_object;
      ...
      function void do_rand();
         ...
         $display("[OBJECT] success=%0d, value=%0d", success, value);
      endfunction
   endclass
   ...
   class my_component_c extends uvm_component;
      ...
      virtual function void build_phase(uvm_phase phase);
         ...
         success = this.randomize();
         $display("[COMPONENT] success=%0d, value=%0d", success, value);
      endfunction
   endclass
   ...
   class my_env_c extends uvm_env;
      ...
      virtual function void build_phase(uvm_phase phase);
         super.build_phase(phase);
         success = this.randomize();
         $display("[ENV] success=%0d, value=%0d", success, value);
      endfunction
   endclass
   ...
   class my_agent_c extends uvm_agent;
      ...
      virtual function void build_phase(uvm_phase phase);
         super.build_phase(phase);
         success = this.randomize();
         $display("[AGENT] success=%0d, value=%0d", success, value);
      endfunction
   endclass
   ...
   class my_driver_c extends uvm_driver#(uvm_sequence_item);
      ...
      virtual function void build_phase(uvm_phase phase);
         super.build_phase(phase);
         success = this.randomize();
         $display("[DRIVER] success=%0d, value=%0d", success, value);
      endfunction
   endclass
   ...
   class my_test_c extends uvm_test;
      ...
      virtual function void build_phase(uvm_phase phase);
         super.build_phase(phase);
         success = this.randomize();
         $display("[TEST] success=%0d, value=%0d", success, value);
      endfunction
   endclass
...
module t_fuxian_uvm_components;
   import uvm_pkg::*;
   ...
   initial begin
      ...
      $display("\n========================================");
      $display("Testing Different UVM Base Classes");
      $display("========================================\n");
      ...
      if (obj.value > 10 && obj.value < 20) begin
         $display("OBJECT: PASS (value=%0d)", obj.value);
      end else begin
         $display("OBJECT: FAIL (value=%0d) - Bug reproduced!", obj.value);
      end
