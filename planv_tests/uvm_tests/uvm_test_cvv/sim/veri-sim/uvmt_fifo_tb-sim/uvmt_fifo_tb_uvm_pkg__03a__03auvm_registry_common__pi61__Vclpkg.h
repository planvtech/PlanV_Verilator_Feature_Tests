...
#ifndef VERILATED_UVMT_FIFO_TB_UVM_PKG__03A__03AUVM_REGISTRY_COMMON__PI61__VCLPKG_H_
#define VERILATED_UVMT_FIFO_TB_UVM_PKG__03A__03AUVM_REGISTRY_COMMON__PI61__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) uvmt_fifo_tb_uvm_pkg__03a__03auvm_registry_common__pi61__Vclpkg final {
  public:

    // DESIGN SPECIFIC STATE
    CData/*0:0*/ __PVT__m___05Finitialized;
    VlQueue<std::string> __PVT__m___05Ftype_aliases;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_registry_common__pi61> __PVT__get__Vstatic__m_inst;
    ...
    // CONSTRUCTORS
    uvmt_fifo_tb_uvm_pkg__03a__03auvm_registry_common__pi61__Vclpkg();
    ~uvmt_fifo_tb_uvm_pkg__03a__03auvm_registry_common__pi61__Vclpkg();
    void ctor(uvmt_fifo_tb__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(uvmt_fifo_tb_uvm_pkg__03a__03auvm_registry_common__pi61__Vclpkg);
    ...
    void __VnoInFunc_get(uvmt_fifo_tb__Syms* __restrict vlSymsp, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_registry_common__pi61> &get__Vfuncrtn);
...
class uvmt_fifo_tb_uvm_pkg__03a__03auvm_registry_common__pi61 : public virtual VlClass {
  public:
  ...
  public:
    uvmt_fifo_tb_uvm_pkg__03a__03auvm_registry_common__pi61(uvmt_fifo_tb__Syms* __restrict vlSymsp);
    std::string to_string() const;
    std::string to_string_middle() const;
    ~uvmt_fifo_tb_uvm_pkg__03a__03auvm_registry_common__pi61() {}
};
