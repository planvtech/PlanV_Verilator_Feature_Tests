...
#ifndef VERILATED_UVMT_FIFO_TB_UVM_PKG__03A__03AUVM_SQR_IF_BASE__TZ34_TBZ34__VCLPKG_H_
#define VERILATED_UVMT_FIFO_TB_UVM_PKG__03A__03AUVM_SQR_IF_BASE__TZ34_TBZ34__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) uvmt_fifo_tb_uvm_pkg__03a__03auvm_sqr_if_base__Tz34_TBz34__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    uvmt_fifo_tb_uvm_pkg__03a__03auvm_sqr_if_base__Tz34_TBz34__Vclpkg();
    ~uvmt_fifo_tb_uvm_pkg__03a__03auvm_sqr_if_base__Tz34_TBz34__Vclpkg();
    void ctor(uvmt_fifo_tb__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(uvmt_fifo_tb_uvm_pkg__03a__03auvm_sqr_if_base__Tz34_TBz34__Vclpkg);
...
class uvmt_fifo_tb_uvm_pkg__03a__03auvm_sqr_if_base__Tz34_TBz34 : public virtual VlClass {
  public:
    ...
    virtual void __VnoInFunc_item_done(uvmt_fifo_tb__Syms* __restrict vlSymsp, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_sequence_item> t);
    ...
    virtual void __VnoInFunc_put_response(uvmt_fifo_tb__Syms* __restrict vlSymsp, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_sequence_item> t);
  ...
  public:
    uvmt_fifo_tb_uvm_pkg__03a__03auvm_sqr_if_base__Tz34_TBz34(VlProcessRef vlProcess, uvmt_fifo_tb__Syms* __restrict vlSymsp);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~uvmt_fifo_tb_uvm_pkg__03a__03auvm_sqr_if_base__Tz34_TBz34();
};
