...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_spell_chkr__Tz17__Vclpkg::__VnoInFunc_check(VlProcessRef vlProcess, uvmt_fifo_tb__Syms* __restrict vlSymsp, VlAssocArray<std::string, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_queue__Tz8>> &strtab, std::string s, CData/*0:0*/ &check__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  uvmt_fifo_tb_uvm_pkg__03a__03auvm_spell_chkr__Tz17__Vclpkg::__VnoInFunc_check\n"); );
    // Locals
    ...
    VlQueue<std::string> min_key;
    {
        ...
        if ((0xffffffffU == min)) {
            if ((0U != ([&]() {
                ...
                __Vtask_uvm_report_info__5__filename = "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_spell_chkr.svh"s;
            ...
            if ((0U != ([&]() {
                ...
                __Vtask_uvm_report_info__13__filename = "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_spell_chkr.svh"s;
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_spell_chkr__Tz17__Vclpkg::__VnoInFunc_levenshtein_distance(uvmt_fifo_tb__Syms* __restrict vlSymsp, std::string s, std::string t, IData/*31:0*/ &levenshtein_distance__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  uvmt_fifo_tb_uvm_pkg__03a__03auvm_spell_chkr__Tz17__Vclpkg::__VnoInFunc_levenshtein_distance\n"); );
    // Locals
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_spell_chkr__Tz17__Vclpkg::__VnoInFunc_minimum(uvmt_fifo_tb__Syms* __restrict vlSymsp, IData/*31:0*/ a, IData/*31:0*/ b, IData/*31:0*/ c, IData/*31:0*/ &minimum__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  uvmt_fifo_tb_uvm_pkg__03a__03auvm_spell_chkr__Tz17__Vclpkg::__VnoInFunc_minimum\n"); );
    // Body
    IData/*31:0*/ min;
    min = 0;
    min = a;
...
uvmt_fifo_tb_uvm_pkg__03a__03auvm_spell_chkr__Tz17::uvmt_fifo_tb_uvm_pkg__03a__03auvm_spell_chkr__Tz17(uvmt_fifo_tb__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  uvmt_fifo_tb_uvm_pkg__03a__03auvm_spell_chkr__Tz17::new\n"); );
    // Body
    _ctor_var_reset(vlSymsp);
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_spell_chkr__Tz17::_ctor_var_reset(uvmt_fifo_tb__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  uvmt_fifo_tb_uvm_pkg__03a__03auvm_spell_chkr__Tz17::_ctor_var_reset\n"); );
    // Body
    (void)vlSymsp;  // Prevent unused variable warning
}

std::string VL_TO_STRING(const VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_spell_chkr__Tz17>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  uvmt_fifo_tb_uvm_pkg__03a__03auvm_spell_chkr__Tz17::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string uvmt_fifo_tb_uvm_pkg__03a__03auvm_spell_chkr__Tz17::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  uvmt_fifo_tb_uvm_pkg__03a__03auvm_spell_chkr__Tz17::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string uvmt_fifo_tb_uvm_pkg__03a__03auvm_spell_chkr__Tz17::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  uvmt_fifo_tb_uvm_pkg__03a__03auvm_spell_chkr__Tz17::to_string_middle\n"); );
    // Body
    std::string out;
    return (out);
}
