...
VL_ATTR_COLD void uvmt_fifo_tb_uvm_pkg___eval_static__TOP__uvm_pkg(uvmt_fifo_tb_uvm_pkg* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              uvmt_fifo_tb_uvm_pkg___eval_static__TOP__uvm_pkg\n"); );
...
VL_ATTR_COLD void uvmt_fifo_tb_uvm_pkg___ctor_var_reset(uvmt_fifo_tb_uvm_pkg* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              uvmt_fifo_tb_uvm_pkg___ctor_var_reset\n"); );
    uvmt_fifo_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
