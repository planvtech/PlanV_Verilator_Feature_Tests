...
#ifndef VERILATED_UVMT_FIFO_TB_UVM_PKG__03A__03AUVM_REG_SEQUENCE__TZ357__VCLPKG_H_
#define VERILATED_UVMT_FIFO_TB_UVM_PKG__03A__03AUVM_REG_SEQUENCE__TZ357__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_sequence__Tz357__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_sequence__Tz357__Vclpkg();
    ~uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_sequence__Tz357__Vclpkg();
    void ctor(uvmt_fifo_tb__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_sequence__Tz357__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_get_type(uvmt_fifo_tb__Syms* __restrict vlSymsp, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_object_registry__Tz392> &get_type__Vfuncrtn);
};
...
class uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_sequence__Tz357 : public uvmt_fifo_tb_uvm_pkg__03a__03auvm_sequence_ {
  public:
  ...
  public:
    uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_sequence__Tz357(VlProcessRef vlProcess, uvmt_fifo_tb__Syms* __restrict vlSymsp, std::string name);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_sequence__Tz357();
};
