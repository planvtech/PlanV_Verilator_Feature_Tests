...
#ifndef VERILATED_UVMT_FIFO_TB_UVMT_FIFO_PKG__03A__03AUVMT_FIFO_TEST_CFG_C__VCLPKG_H_
#define VERILATED_UVMT_FIFO_TB_UVMT_FIFO_PKG__03A__03AUVMT_FIFO_TEST_CFG_C__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) uvmt_fifo_tb_uvmt_fifo_pkg__03a__03auvmt_fifo_test_cfg_c__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    uvmt_fifo_tb_uvmt_fifo_pkg__03a__03auvmt_fifo_test_cfg_c__Vclpkg();
    ~uvmt_fifo_tb_uvmt_fifo_pkg__03a__03auvmt_fifo_test_cfg_c__Vclpkg();
    void ctor(uvmt_fifo_tb__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(uvmt_fifo_tb_uvmt_fifo_pkg__03a__03auvmt_fifo_test_cfg_c__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_get_type(uvmt_fifo_tb__Syms* __restrict vlSymsp, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_object_registry__pi66> &get_type__Vfuncrtn);
...
class uvmt_fifo_tb_uvmt_fifo_pkg__03a__03auvmt_fifo_test_cfg_c : public uvmt_fifo_tb_uvm_pkg__03a__03auvm_object {
  public:

    // DESIGN SPECIFIC STATE
    IData/*31:0*/ __PVT__watchdog_timeout;
    ...
    void __VnoInFunc_timeout_default_cons_setup_constraint(uvmt_fifo_tb__Syms* __restrict vlSymsp);
  private:
    void _ctor_var_reset(uvmt_fifo_tb__Syms* __restrict vlSymsp);
  public:
    uvmt_fifo_tb_uvmt_fifo_pkg__03a__03auvmt_fifo_test_cfg_c(VlProcessRef vlProcess, uvmt_fifo_tb__Syms* __restrict vlSymsp, std::string name);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~uvmt_fifo_tb_uvmt_fifo_pkg__03a__03auvmt_fifo_test_cfg_c();
};
