...
void uvmt_fifo_tb::m__uvm_report_dpi(int severity, const char* id, const char* message, int verbosity, const char* filename, int line) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    uvmt_fifo_tb___024root::m__uvm_report_dpi\n"); );
    // Locals
    ...
    uvmt_fifo_tb__Vcb_m___05Fuvm_report_dpi_t __Vcb = reinterpret_cast<uvmt_fifo_tb__Vcb_m___05Fuvm_report_dpi_t>(VerilatedScope::exportFind(__Vscopep, __Vfuncnum));
    ...
    line__Vcvt = (line);
    (*__Vcb)((uvmt_fifo_tb__Syms*)(__Vscopep->symsp()), severity__Vcvt, id__Vcvt, message__Vcvt, verbosity__Vcvt, filename__Vcvt, line__Vcvt);
}
