...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_component_name_check_visitor::__VnoInFunc_get_name_constraint(uvmt_fifo_tb__Syms* __restrict vlSymsp, std::string &get_name_constraint__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_component_name_check_visitor::__VnoInFunc_get_name_constraint\n"); );
    // Body
    get_name_constraint__Vfuncrtn = "/^[][[:alnum:](){}_:-]([][[:alnum:](){} _:-]*[][[:alnum:](){}_:-])?$/"s;
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_component_name_check_visitor::__VnoInFunc_visit(VlProcessRef vlProcess, uvmt_fifo_tb__Syms* __restrict vlSymsp, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_component> node) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_component_name_check_visitor::__VnoInFunc_visit\n"); );
    // Locals
    ...
    if ((this->__PVT___root != node)) {
        if ((1U & (~ ([&]() {
                            __Vfunc_uvm_is_match__0__str 
                                = VL_CVT_PACK_STR_NN(
                                                     ([&]() {
                                        VL_NULL_CHECK(node, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_traversal.svh", 273)
            ...
            if ((0U != ([&]() {
                ...
                __Vtask_uvm_report_warning__9__filename = "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_traversal.svh"s;
                __Vtask_uvm_report_warning__9__verbosity = 0U;
                __Vtemp_1 = ([&]() {
                        VL_NULL_CHECK(node, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_traversal.svh", 274)
...
uvmt_fifo_tb_uvm_pkg__03a__03auvm_component_name_check_visitor::uvmt_fifo_tb_uvm_pkg__03a__03auvm_component_name_check_visitor(VlProcessRef vlProcess, uvmt_fifo_tb__Syms* __restrict vlSymsp, std::string name)
    : uvmt_fifo_tb_uvm_pkg__03a__03auvm_visitor_(vlProcess, vlSymsp, name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_component_name_check_visitor::new\n"); );
    // Body
    _ctor_var_reset(vlSymsp);
    ;
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_component_name_check_visitor::__VnoInFunc_begin_v(VlProcessRef vlProcess, uvmt_fifo_tb__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_component_name_check_visitor::__VnoInFunc_begin_v\n"); );
    // Locals
    ...
    VL_NULL_CHECK(cs, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_traversal.svh", 286)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__17__Vfuncout);
    ...
    if ((0U != ([&]() {
        ...
        __Vtask_uvm_report_info__22__filename = "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_traversal.svh"s;
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_component_name_check_visitor::__VnoInFunc___Vsetup_constraints(uvmt_fifo_tb__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_component_name_check_visitor::__VnoInFunc___Vsetup_constraints\n"); );
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_component_name_check_visitor::__VnoInFunc___VBasicRand(uvmt_fifo_tb__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_component_name_check_visitor::__VnoInFunc___VBasicRand\n"); );
    // Body
    __VBasicRand__Vfuncrtn = 1U;
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_component_name_check_visitor::_ctor_var_reset(uvmt_fifo_tb__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_component_name_check_visitor::_ctor_var_reset\n"); );
    // Body
    (void)vlSymsp;  // Prevent unused variable warning
}

uvmt_fifo_tb_uvm_pkg__03a__03auvm_component_name_check_visitor::~uvmt_fifo_tb_uvm_pkg__03a__03auvm_component_name_check_visitor() {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_component_name_check_visitor::~\n"); );
}

std::string VL_TO_STRING(const VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_component_name_check_visitor>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_component_name_check_visitor::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string uvmt_fifo_tb_uvm_pkg__03a__03auvm_component_name_check_visitor::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_component_name_check_visitor::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string uvmt_fifo_tb_uvm_pkg__03a__03auvm_component_name_check_visitor::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_component_name_check_visitor::to_string_middle\n"); );
    // Body
    std::string out;
    out += "_root:" + VL_TO_STRING(__PVT___root);
    out += ", "+ uvmt_fifo_tb_uvm_pkg__03a__03auvm_visitor_::to_string_middle();
    return (out);
}
