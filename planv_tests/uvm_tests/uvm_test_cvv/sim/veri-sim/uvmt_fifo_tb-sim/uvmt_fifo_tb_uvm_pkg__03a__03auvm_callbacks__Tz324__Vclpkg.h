...
#ifndef VERILATED_UVMT_FIFO_TB_UVM_PKG__03A__03AUVM_CALLBACKS__TZ324__VCLPKG_H_
#define VERILATED_UVMT_FIFO_TB_UVM_PKG__03A__03AUVM_CALLBACKS__TZ324__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) uvmt_fifo_tb_uvm_pkg__03a__03auvm_callbacks__Tz324__Vclpkg final {
  public:

    // DESIGN SPECIFIC STATE
    std::string __PVT__m_typename;
    std::string __PVT__m_cb_typename;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_callbacks__Tz324> __PVT__m_inst;
    ...
    // CONSTRUCTORS
    uvmt_fifo_tb_uvm_pkg__03a__03auvm_callbacks__Tz324__Vclpkg();
    ~uvmt_fifo_tb_uvm_pkg__03a__03auvm_callbacks__Tz324__Vclpkg();
    void ctor(uvmt_fifo_tb__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(uvmt_fifo_tb_uvm_pkg__03a__03auvm_callbacks__Tz324__Vclpkg);
    ...
    void __VnoInFunc_get(VlProcessRef vlProcess, uvmt_fifo_tb__Syms* __restrict vlSymsp, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_callbacks__Tz324> &get__Vfuncrtn);
    void __VnoInFunc_get_all(uvmt_fifo_tb__Syms* __restrict vlSymsp, VlQueue<VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_callback>> &all_callbacks, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_backdoor> obj);
    void __VnoInFunc_get_first(uvmt_fifo_tb__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_backdoor> obj, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_callback> &get_first__Vfuncrtn);
    void __VnoInFunc_get_last(uvmt_fifo_tb__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_backdoor> obj, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_callback> &get_last__Vfuncrtn);
    void __VnoInFunc_get_next(uvmt_fifo_tb__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_backdoor> obj, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_callback> &get_next__Vfuncrtn);
    void __VnoInFunc_get_prev(uvmt_fifo_tb__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_backdoor> obj, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_callback> &get_prev__Vfuncrtn);
    void __VnoInFunc_m_get_q(uvmt_fifo_tb__Syms* __restrict vlSymsp, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_queue__Tz55> &q, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_backdoor> obj);
...
class uvmt_fifo_tb_uvm_pkg__03a__03auvm_callbacks__Tz324 : public uvmt_fifo_tb_uvm_pkg__03a__03auvm_typed_callbacks__Tz324 {
  public:
  ...
  public:
    uvmt_fifo_tb_uvm_pkg__03a__03auvm_callbacks__Tz324(VlProcessRef vlProcess, uvmt_fifo_tb__Syms* __restrict vlSymsp);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~uvmt_fifo_tb_uvm_pkg__03a__03auvm_callbacks__Tz324();
};
