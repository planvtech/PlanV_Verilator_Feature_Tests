...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer__Vclpkg::__VnoInFunc_get_type(uvmt_fifo_tb__Syms* __restrict vlSymsp, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_object_registry__pi10> &get_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer__Vclpkg::__VnoInFunc_get_type\n"); );
    // Locals
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_object_registry__pi10> __Vfunc_get__0__Vfuncout;
    // Body
    vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__pi10__Vclpkg.__VnoInFunc_get(vlSymsp, __Vfunc_get__0__Vfuncout);
    get_type__Vfuncrtn = __Vfunc_get__0__Vfuncout;
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer__Vclpkg::__VnoInFunc_type_name(uvmt_fifo_tb__Syms* __restrict vlSymsp, std::string &type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer__Vclpkg::__VnoInFunc_type_name\n"); );
    // Body
    type_name__Vfuncrtn = "uvm_packer"s;
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer__Vclpkg::__VnoInFunc_set_default(uvmt_fifo_tb__Syms* __restrict vlSymsp, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer> packer) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer__Vclpkg::__VnoInFunc_set_default\n"); );
    // Locals
    ...
    VL_NULL_CHECK(coreservice, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_packer.svh", 123)->__VnoInFunc_set_default_packer(vlSymsp, packer);
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer__Vclpkg::__VnoInFunc_get_default(uvmt_fifo_tb__Syms* __restrict vlSymsp, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer> &get_default__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer__Vclpkg::__VnoInFunc_get_default\n"); );
    // Locals
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__3__Vfuncout;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer> __Vtask_get_default_packer__4__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_coreservice_t> coreservice;
    ...
    VL_NULL_CHECK(coreservice, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_packer.svh", 130)->__VnoInFunc_get_default_packer(vlSymsp, __Vtask_get_default_packer__4__Vfuncout);
    get_default__Vfuncrtn = __Vtask_get_default_packer__4__Vfuncout;
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_get_object_type(VlProcessRef vlProcess, uvmt_fifo_tb__Syms* __restrict vlSymsp, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_object_wrapper> &get_object_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_get_object_type\n"); );
    // Locals
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_object_registry__pi10> __Vfunc_get__0__Vfuncout;
    // Body
    vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__pi10__Vclpkg.__VnoInFunc_get(vlSymsp, __Vfunc_get__0__Vfuncout);
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_create(VlProcessRef vlProcess, uvmt_fifo_tb__Syms* __restrict vlSymsp, std::string name, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_object> &create__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_create\n"); );
    // Body
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer> tmp;
    tmp = ((""s == name) ? VL_NEW(uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer, vlProcess, vlSymsp, ""s)
            : VL_NEW(uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer, vlProcess, vlSymsp, name));
    create__Vfuncrtn = tmp;
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_get_type_name(uvmt_fifo_tb__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_get_type_name\n"); );
    // Body
    get_type_name__Vfuncrtn = "uvm_packer"s;
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_index_error(uvmt_fifo_tb__Syms* __restrict vlSymsp, IData/*31:0*/ index, std::string id, IData/*31:0*/ sz) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_index_error\n"); );
    // Locals
    ...
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__4__Vfuncout;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_root> __Vtask_get_root__5__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_enough_bits(VlProcessRef vlProcess, uvmt_fifo_tb__Syms* __restrict vlSymsp, IData/*31:0*/ needed, std::string id, CData/*0:0*/ &enough_bits__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_enough_bits\n"); );
    // Locals
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_get_packed_size(uvmt_fifo_tb__Syms* __restrict vlSymsp, IData/*31:0*/ &get_packed_size__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_get_packed_size\n"); );
    // Body
    get_packed_size__Vfuncrtn = (this->__PVT__m_pack_iter 
                                 - this->__PVT__m_unpack_iter);
}

extern const VlWide<1024>/*32767:0*/ uvmt_fifo_tb__ConstPool__CONST_hbc03216d_0;

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_flush(VlProcessRef vlProcess, uvmt_fifo_tb__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_flush\n"); );
    // Body
    this->__PVT__m_pack_iter = 0x00000040U;
    this->__PVT__m_unpack_iter = 0x00000040U;
    VL_ASSIGN_W(32768, this->__PVT__m_bits, uvmt_fifo_tb__ConstPool__CONST_hbc03216d_0);
    this->__PVT__m_object_references.clear();
    this->__PVT__m_object_references.at(0U) = VlNull{};
    this->__PVT__m_factory = VlNull{};
    uvmt_fifo_tb_uvm_pkg__03a__03auvm_policy::__VnoInFunc_flush(vlProcess, vlSymsp);
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_get_packed_bits(uvmt_fifo_tb__Syms* __restrict vlSymsp, VlQueue<CData/*0:0*/> &stream) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_get_packed_bits\n"); );
    // Body
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_get_packed_bytes(uvmt_fifo_tb__Syms* __restrict vlSymsp, VlQueue<CData/*7:0*/> &stream) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_get_packed_bytes\n"); );
    // Body
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_get_packed_ints(uvmt_fifo_tb__Syms* __restrict vlSymsp, VlQueue<IData/*31:0*/> &stream) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_get_packed_ints\n"); );
    // Body
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_get_packed_longints(uvmt_fifo_tb__Syms* __restrict vlSymsp, VlQueue<QData/*63:0*/> &stream) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_get_packed_longints\n"); );
    // Body
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_set_packed_bits(uvmt_fifo_tb__Syms* __restrict vlSymsp, VlQueue<CData/*0:0*/> &stream) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_set_packed_bits\n"); );
    // Body
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_set_packed_bytes(uvmt_fifo_tb__Syms* __restrict vlSymsp, VlQueue<CData/*7:0*/> &stream) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_set_packed_bytes\n"); );
    // Body
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_set_packed_ints(uvmt_fifo_tb__Syms* __restrict vlSymsp, VlQueue<IData/*31:0*/> &stream) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_set_packed_ints\n"); );
    // Body
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_set_packed_longints(uvmt_fifo_tb__Syms* __restrict vlSymsp, VlQueue<QData/*63:0*/> &stream) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_set_packed_longints\n"); );
    // Body
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_pack_object(VlProcessRef vlProcess, uvmt_fifo_tb__Syms* __restrict vlSymsp, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_object> value) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_pack_object\n"); );
    // Locals
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_field_op> __Vfunc_m_get_available_op__13__Vfuncout;
    CData/*0:0*/ __Vtask_user_hook_enabled__16__Vfuncout;
    __Vtask_user_hook_enabled__16__Vfuncout = 0;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_object> __Vtask_pop_active_object__19__Vfuncout;
    // Body
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_field_op> field_op;
    {
        ...
        VL_NULL_CHECK(field_op, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_packer.svh", 688)->__VnoInFunc_set(vlProcess, vlSymsp, 0x00000100U, 
                                                                                VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer>{this}, value);
        VL_NULL_CHECK(value, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_packer.svh", 689)->__VnoInFunc_do_execute_op(vlProcess, vlSymsp, field_op);
        if (([&]() {
                    VL_NULL_CHECK(field_op, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_packer.svh", 690)
            ...
            VL_NULL_CHECK(value, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_packer.svh", 691)->__VnoInFunc_do_pack(vlProcess, vlSymsp, 
                                                                                VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer>{this});
        }
        VL_NULL_CHECK(field_op, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_packer.svh", 693)->__VnoInFunc_m_recycle(vlSymsp);
        this->__VnoInFunc_pop_active_object(vlProcess, vlSymsp, __Vtask_pop_active_object__19__Vfuncout);
        __Vlabel0: ;
    }
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_pack_object_with_meta(VlProcessRef vlProcess, uvmt_fifo_tb__Syms* __restrict vlSymsp, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_object> value) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_pack_object_with_meta\n"); );
    // Locals
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_object_wrapper> __Vtask_get_object_type__23__Vfuncout;
    // Body
    ...
    reference_id = 0;
    {
        ...
        this->__VnoInFunc_pack_object_wrapper(vlSymsp, 
                                              ([&]() {
                    VL_NULL_CHECK(value, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_packer.svh", 728)
                                               ->__VnoInFunc_get_object_type(vlProcess, vlSymsp, __Vtask_get_object_type__23__Vfuncout);
                }(), __Vtask_get_object_type__23__Vfuncout));
        this->__VnoInFunc_pack_object(vlProcess, vlSymsp, value);
        __Vlabel0: ;
    }
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_pack_object_wrapper(uvmt_fifo_tb__Syms* __restrict vlSymsp, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_object_wrapper> value) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_pack_object_wrapper\n"); );
    // Locals
    ...
    if ((VlNull{} != value)) {
        this->__VnoInFunc_pack_string(vlSymsp, VL_CVT_PACK_STR_NN(
                                                                  ([&]() {
                        VL_NULL_CHECK(value, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_packer.svh", 737)
                                                                   ->__VnoInFunc_get_type_name(vlSymsp, __Vtask_get_type_name__26__Vfuncout);
                    }(), __Vtask_get_type_name__26__Vfuncout)));
    }
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_pack_real(uvmt_fifo_tb__Syms* __restrict vlSymsp, double value) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_pack_real\n"); );
    // Body
    this->__VnoInFunc_pack_field_int(vlSymsp, VL_CVT_Q_D(value), 0x00000040U);
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_pack_time(uvmt_fifo_tb__Syms* __restrict vlSymsp, QData/*63:0*/ value) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_pack_time\n"); );
    // Body
    this->__VnoInFunc_pack_field_int(vlSymsp, value, 0x00000040U);
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_pack_field(uvmt_fifo_tb__Syms* __restrict vlSymsp, VlWide<128>/*4095:0*/ value, IData/*31:0*/ size) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_pack_field\n"); );
    // Body
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_pack_field_int(uvmt_fifo_tb__Syms* __restrict vlSymsp, QData/*63:0*/ value, IData/*31:0*/ size) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_pack_field_int\n"); );
    // Body
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_pack_bits(VlProcessRef vlProcess, uvmt_fifo_tb__Syms* __restrict vlSymsp, VlQueue<CData/*0:0*/> &value, IData/*31:0*/ size) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_pack_bits\n"); );
    // Locals
    ...
    unnamedblk61__DOT__i = 0;
    {
        ...
        if (VL_GTS_III(32, size, value.size())) {
            if ((0U != ([&]() {
                ...
                __Vtask_uvm_report_error__33__filename = "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_packer.svh"s;
                ...
                VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_error__Vstatic__cs, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_globals.svh", 174)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__35__Vfuncout);
                vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_error__Vstatic__top 
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_pack_bytes(uvmt_fifo_tb__Syms* __restrict vlSymsp, VlQueue<CData/*7:0*/> &value, IData/*31:0*/ size) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_pack_bytes\n"); );
    // Locals
    ...
    if (VL_GTS_III(32, size, max_size)) {
        if ((0U != ([&]() {
            ...
            __Vtask_uvm_report_error__41__filename = "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_packer.svh"s;
            ...
            VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_error__Vstatic__cs, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_globals.svh", 174)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__43__Vfuncout);
            vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_error__Vstatic__top 
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_pack_ints(uvmt_fifo_tb__Syms* __restrict vlSymsp, VlQueue<IData/*31:0*/> &value, IData/*31:0*/ size) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_pack_ints\n"); );
    // Locals
    ...
    if (VL_GTS_III(32, size, max_size)) {
        if ((0U != ([&]() {
            ...
            __Vtask_uvm_report_error__49__filename = "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_packer.svh"s;
            ...
            VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_error__Vstatic__cs, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_globals.svh", 174)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__51__Vfuncout);
            vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_error__Vstatic__top 
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_pack_string(uvmt_fifo_tb__Syms* __restrict vlSymsp, std::string value) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_pack_string\n"); );
    // Body
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_is_null(uvmt_fifo_tb__Syms* __restrict vlSymsp, CData/*0:0*/ &is_null__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_is_null\n"); );
    // Body
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_is_object_wrapper(uvmt_fifo_tb__Syms* __restrict vlSymsp, CData/*0:0*/ &is_object_wrapper__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_is_object_wrapper\n"); );
    // Body
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_unpack_object(VlProcessRef vlProcess, uvmt_fifo_tb__Syms* __restrict vlSymsp, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_object> value) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_unpack_object\n"); );
    // Locals
    ...
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_field_op> __Vfunc_m_get_available_op__71__Vfuncout;
    CData/*0:0*/ __Vtask_user_hook_enabled__74__Vfuncout;
    __Vtask_user_hook_enabled__74__Vfuncout = 0;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_object> __Vtask_pop_active_object__77__Vfuncout;
    // Body
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_field_op> field_op;
    {
        if (([&]() {
            ...
            if ((VlNull{} != value)) {
                if ((0U != ([&]() {
                    ...
                    __Vtask_uvm_report_error__58__filename = "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_packer.svh"s;
                    ...
                    VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_error__Vstatic__cs, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_globals.svh", 174)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__60__Vfuncout);
                    vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_error__Vstatic__top 
            ...
            if ((VlNull{} == value)) {
                if ((0U != ([&]() {
                    ...
                    __Vtask_uvm_report_error__66__filename = "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_packer.svh"s;
                    ...
                    VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_error__Vstatic__cs, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_globals.svh", 174)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__68__Vfuncout);
                    vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_error__Vstatic__top 
            ...
            VL_NULL_CHECK(field_op, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_packer.svh", 943)->__VnoInFunc_set(vlProcess, vlSymsp, 0x00000400U, 
                                                                                VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer>{this}, value);
            VL_NULL_CHECK(value, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_packer.svh", 944)->__VnoInFunc_do_execute_op(vlProcess, vlSymsp, field_op);
            if (([&]() {
                        VL_NULL_CHECK(field_op, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_packer.svh", 945)
                ...
                VL_NULL_CHECK(value, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_packer.svh", 946)->__VnoInFunc_do_unpack(vlProcess, vlSymsp, 
                                                                                VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer>{this});
            }
            VL_NULL_CHECK(field_op, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_packer.svh", 948)->__VnoInFunc_m_recycle(vlSymsp);
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_unpack_object_with_meta(VlProcessRef vlProcess, uvmt_fifo_tb__Syms* __restrict vlSymsp, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_object> &value) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_unpack_object_with_meta\n"); );
    // Locals
    QData/*63:0*/ __Vfunc_unpack_field_int__78__Vfuncout;
    __Vfunc_unpack_field_int__78__Vfuncout = 0;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_object_wrapper> __Vfunc_unpack_object_wrapper__79__Vfuncout;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_object_wrapper> __Vtask_get_object_type__80__Vfuncout;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_object> __Vtask_create_object__81__Vfuncout;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_component> __Vtask_create_component__82__Vfuncout;
    // Body
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_object_wrapper> unnamedblk67__DOT_____05Fwrapper;
    IData/*31:0*/ reference_id;
    reference_id = 0;
    {
        reference_id = (IData)(([&]() {
        ...
        if (this->__PVT__m_object_references.exists(reference_id)) {
            ...
            this->__VnoInFunc_unpack_object_wrapper(vlProcess, vlSymsp, __Vfunc_unpack_object_wrapper__79__Vfuncout);
            unnamedblk67__DOT_____05Fwrapper = __Vfunc_unpack_object_wrapper__79__Vfuncout;
            if (((VlNull{} != unnamedblk67__DOT_____05Fwrapper) 
                 && ((VlNull{} == value) || (([&]() {
                                    VL_NULL_CHECK(value, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_packer.svh", 986)
                                              ->__VnoInFunc_get_object_type(vlProcess, vlSymsp, __Vtask_get_object_type__80__Vfuncout);
                                }(), __Vtask_get_object_type__80__Vfuncout) 
                                             != unnamedblk67__DOT_____05Fwrapper)))) {
                VL_NULL_CHECK(unnamedblk67__DOT_____05Fwrapper, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_packer.svh", 987)->__VnoInFunc_create_object(vlProcess, vlSymsp, ""s, __Vtask_create_object__81__Vfuncout);
                value = __Vtask_create_object__81__Vfuncout;
                if ((VlNull{} == value)) {
                    VL_NULL_CHECK(unnamedblk67__DOT_____05Fwrapper, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_packer.svh", 989)->__VnoInFunc_create_component(vlProcess, vlSymsp, ""s, VlNull{}, __Vtask_create_component__82__Vfuncout);
        ...
        this->__PVT__m_object_references.at(reference_id) 
            = value;
        this->__VnoInFunc_unpack_object(vlProcess, vlSymsp, value);
        __Vlabel0: ;
    }
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_unpack_object_wrapper(VlProcessRef vlProcess, uvmt_fifo_tb__Syms* __restrict vlSymsp, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_object_wrapper> &unpack_object_wrapper__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_unpack_object_wrapper\n"); );
    // Locals
    std::string __Vfunc_unpack_string__84__Vfuncout;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_factory> __Vfunc_get__85__Vfuncout;
    CData/*0:0*/ __Vtask_is_type_name_registered__86__Vfuncout;
    __Vtask_is_type_name_registered__86__Vfuncout = 0;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_object_wrapper> __Vtask_find_wrapper_by_name__87__Vfuncout;
    // Body
    std::string type_name;
    {
        ...
        if (([&]() {
                    VL_NULL_CHECK(this->__PVT__m_factory, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_packer.svh", 1003)
            ...
            VL_NULL_CHECK(this->__PVT__m_factory, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_packer.svh", 1004)->__VnoInFunc_find_wrapper_by_name(vlProcess, vlSymsp, type_name, __Vtask_find_wrapper_by_name__87__Vfuncout);
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_unpack_real(uvmt_fifo_tb__Syms* __restrict vlSymsp, double &unpack_real__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_unpack_real\n"); );
    // Locals
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_unpack_time(uvmt_fifo_tb__Syms* __restrict vlSymsp, QData/*63:0*/ &unpack_time__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_unpack_time\n"); );
    // Locals
...
extern const VlWide<128>/*4095:0*/ uvmt_fifo_tb__ConstPool__CONST_h6e0f3f36_0;

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_unpack_field(uvmt_fifo_tb__Syms* __restrict vlSymsp, IData/*31:0*/ size, VlWide<128>/*4095:0*/ &unpack_field__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_unpack_field\n"); );
    // Locals
    ...
    while ((__Vilp1 <= 0x0000007fU)) {
        unpack_field__Vfuncrtn[__Vilp1] = uvmt_fifo_tb__ConstPool__CONST_h6e0f3f36_0[__Vilp1];
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_unpack_field_int(VlProcessRef vlProcess, uvmt_fifo_tb__Syms* __restrict vlSymsp, IData/*31:0*/ size, QData/*63:0*/ &unpack_field_int__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_unpack_field_int\n"); );
    // Locals
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_unpack_bits(VlProcessRef vlProcess, uvmt_fifo_tb__Syms* __restrict vlSymsp, VlQueue<CData/*0:0*/> &value, IData/*31:0*/ size) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_unpack_bits\n"); );
    // Locals
    ...
    unnamedblk70__DOT__i = 0;
    {
        ...
        if (VL_GTS_III(32, size, value.size())) {
            if ((0U != ([&]() {
                ...
                __Vtask_uvm_report_error__98__filename = "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_packer.svh"s;
                ...
                VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_error__Vstatic__cs, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_globals.svh", 174)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__100__Vfuncout);
                vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_error__Vstatic__top 
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_unpack_bytes(uvmt_fifo_tb__Syms* __restrict vlSymsp, VlQueue<CData/*7:0*/> &value, IData/*31:0*/ size) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_unpack_bytes\n"); );
    // Locals
    ...
    if (VL_GTS_III(32, size, max_size)) {
        if ((0U != ([&]() {
            ...
            __Vtask_uvm_report_error__107__filename = "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_packer.svh"s;
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_unpack_ints(uvmt_fifo_tb__Syms* __restrict vlSymsp, VlQueue<IData/*31:0*/> &value, IData/*31:0*/ size) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_unpack_ints\n"); );
    // Locals
    ...
    if (VL_GTS_III(32, size, max_size)) {
        if ((0U != ([&]() {
            ...
            __Vtask_uvm_report_error__116__filename = "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_packer.svh"s;
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_unpack_string(VlProcessRef vlProcess, uvmt_fifo_tb__Syms* __restrict vlSymsp, std::string &unpack_string__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_unpack_string\n"); );
    // Locals
...
uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer(VlProcessRef vlProcess, uvmt_fifo_tb__Syms* __restrict vlSymsp, std::string name)
    : uvmt_fifo_tb_uvm_pkg__03a__03auvm_policy(vlProcess, vlSymsp, name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::new\n"); );
    // Body
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_randomize(uvmt_fifo_tb__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc_randomize\n"); );
    // Locals
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc___Vsetup_constraints(uvmt_fifo_tb__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc___Vsetup_constraints\n"); );
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc___VBasicRand(uvmt_fifo_tb__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::__VnoInFunc___VBasicRand\n"); );
    // Body
    __VBasicRand__Vfuncrtn = 1U;
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::_ctor_var_reset(uvmt_fifo_tb__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::_ctor_var_reset\n"); );
    // Body
...
uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::~uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer() {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::~\n"); );
}

std::string VL_TO_STRING(const VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer::to_string_middle\n"); );
    // Body
    std::string out;
