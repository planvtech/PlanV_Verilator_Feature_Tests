...
#ifndef VERILATED_UVMT_FIFO_TB_UVM_PKG__03A__03AUVM_TOPDOWN_PHASE__VCLPKG_H_
#define VERILATED_UVMT_FIFO_TB_UVM_PKG__03A__03AUVM_TOPDOWN_PHASE__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) uvmt_fifo_tb_uvm_pkg__03a__03auvm_topdown_phase__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    uvmt_fifo_tb_uvm_pkg__03a__03auvm_topdown_phase__Vclpkg();
    ~uvmt_fifo_tb_uvm_pkg__03a__03auvm_topdown_phase__Vclpkg();
    void ctor(uvmt_fifo_tb__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(uvmt_fifo_tb_uvm_pkg__03a__03auvm_topdown_phase__Vclpkg);
...
class uvmt_fifo_tb_uvm_pkg__03a__03auvm_topdown_phase : public uvmt_fifo_tb_uvm_pkg__03a__03auvm_phase {
  public:
  ...
  public:
    uvmt_fifo_tb_uvm_pkg__03a__03auvm_topdown_phase(VlProcessRef vlProcess, uvmt_fifo_tb__Syms* __restrict vlSymsp, std::string name);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~uvmt_fifo_tb_uvm_pkg__03a__03auvm_topdown_phase();
};
