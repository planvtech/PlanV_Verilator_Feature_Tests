...
#ifndef VERILATED_UVMT_FIFO_TB_UVM_PKG__03A__03AUVM_RESOURCE_DB__TZ321__VCLPKG_H_
#define VERILATED_UVMT_FIFO_TB_UVM_PKG__03A__03AUVM_RESOURCE_DB__TZ321__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) uvmt_fifo_tb_uvm_pkg__03a__03auvm_resource_db__Tz321__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    uvmt_fifo_tb_uvm_pkg__03a__03auvm_resource_db__Tz321__Vclpkg();
    ~uvmt_fifo_tb_uvm_pkg__03a__03auvm_resource_db__Tz321__Vclpkg();
    void ctor(uvmt_fifo_tb__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(uvmt_fifo_tb_uvm_pkg__03a__03auvm_resource_db__Tz321__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_dump(uvmt_fifo_tb__Syms* __restrict vlSymsp);
    void __VnoInFunc_get_by_name(uvmt_fifo_tb__Syms* __restrict vlSymsp, std::string scope, std::string name, CData/*0:0*/ rpterr, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_resource__Tz321> &get_by_name__Vfuncrtn);
    void __VnoInFunc_get_by_type(uvmt_fifo_tb__Syms* __restrict vlSymsp, std::string scope, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_resource__Tz321> &get_by_type__Vfuncrtn);
    void __VnoInFunc_m_show_msg(uvmt_fifo_tb__Syms* __restrict vlSymsp, std::string id, std::string rtype, std::string action, std::string scope, std::string name, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_object> accessor, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_resource__Tz321> rsrc);
    ...
    void __VnoInFunc_set_default(uvmt_fifo_tb__Syms* __restrict vlSymsp, std::string scope, std::string name, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_resource__Tz321> &set_default__Vfuncrtn);
...
class uvmt_fifo_tb_uvm_pkg__03a__03auvm_resource_db__Tz321 : public virtual VlClass {
  public:
  private:
    void _ctor_var_reset(uvmt_fifo_tb__Syms* __restrict vlSymsp);
  public:
    uvmt_fifo_tb_uvm_pkg__03a__03auvm_resource_db__Tz321(uvmt_fifo_tb__Syms* __restrict vlSymsp);
    std::string to_string() const;
    std::string to_string_middle() const;
    ~uvmt_fifo_tb_uvm_pkg__03a__03auvm_resource_db__Tz321() {}
};
