...
#ifndef VERILATED_UVMT_FIFO_TB_UVM_PKG__03A__03AUVM_DEFAULT_FACTORY__VCLPKG_H_
#define VERILATED_UVMT_FIFO_TB_UVM_PKG__03A__03AUVM_DEFAULT_FACTORY__VCLPKG_H_  // guard
...
class uvmt_fifo_tb_uvm_pkg__03a__03auvm_factory_override;
class uvmt_fifo_tb_uvm_pkg__03a__03auvm_factory_queue_class;
...
struct uvmt_fifo_tb_m_inst_typename_alias_t__struct__0 {
    ...
    bool operator==(const uvmt_fifo_tb_m_inst_typename_alias_t__struct__0& rhs) const {
...
template <>
struct VlIsCustomStruct<uvmt_fifo_tb_m_inst_typename_alias_t__struct__0> : public std::true_type {};

class alignas(VL_CACHE_LINE_BYTES) uvmt_fifo_tb_uvm_pkg__03a__03auvm_default_factory__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    uvmt_fifo_tb_uvm_pkg__03a__03auvm_default_factory__Vclpkg();
    ~uvmt_fifo_tb_uvm_pkg__03a__03auvm_default_factory__Vclpkg();
    void ctor(uvmt_fifo_tb__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(uvmt_fifo_tb_uvm_pkg__03a__03auvm_default_factory__Vclpkg);
...
class uvmt_fifo_tb_uvm_pkg__03a__03auvm_default_factory : public uvmt_fifo_tb_uvm_pkg__03a__03auvm_factory {
  public:

    // DESIGN SPECIFIC STATE
    VlAssocArray<VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_object_wrapper>, CData/*0:0*/> __PVT__m_types;
    VlAssocArray<std::string, CData/*0:0*/> __PVT__m_lookup_strs;
    VlQueue<uvmt_fifo_tb_m_inst_typename_alias_t__struct__0> __PVT__m_inst_aliases;
    VlAssocArray<std::string, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_object_wrapper>> __PVT__m_type_names;
    VlQueue<VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_factory_override>> __PVT__m_type_overrides;
    VlQueue<VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_factory_override>> __PVT__m_inst_overrides;
    VlQueue<VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_factory_override>> __PVT__m_override_info;
    ...
    void __VnoInFunc_m_debug_create(VlProcessRef vlProcess, uvmt_fifo_tb__Syms* __restrict vlSymsp, std::string requested_type_name, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_object_wrapper> requested_type, std::string parent_inst_path, std::string name);
    void __VnoInFunc_m_debug_display(VlProcessRef vlProcess, uvmt_fifo_tb__Syms* __restrict vlSymsp, std::string requested_type_name, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_object_wrapper> result, std::string full_inst_path);
    void __VnoInFunc_m_matches_inst_override(uvmt_fifo_tb__Syms* __restrict vlSymsp, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_factory_override> __SYM__override, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_object_wrapper> requested_type, std::string requested_type_name, std::string full_inst_path, CData/*0:0*/ &m_matches_inst_override__Vfuncrtn);
    void __VnoInFunc_m_matches_type_override(uvmt_fifo_tb__Syms* __restrict vlSymsp, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_factory_override> __SYM__override, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_object_wrapper> requested_type, std::string requested_type_name, std::string full_inst_path, CData/*0:0*/ match_original_type, CData/*0:0*/ resolve_null_type_by_inst, CData/*0:0*/ &m_matches_type_override__Vfuncrtn);
    void __VnoInFunc_m_matches_type_pair(uvmt_fifo_tb__Syms* __restrict vlSymsp, uvmt_fifo_tb_m_uvm_factory_type_pair_t__struct__0 match_type_pair, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_object_wrapper> requested_type, std::string requested_type_name, CData/*0:0*/ &m_matches_type_pair__Vfuncrtn);
    void __VnoInFunc_m_resolve_type_name(uvmt_fifo_tb__Syms* __restrict vlSymsp, std::string requested_type_name, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_object_wrapper> &m_resolve_type_name__Vfuncrtn);
    void __VnoInFunc_m_resolve_type_name_by_inst(uvmt_fifo_tb__Syms* __restrict vlSymsp, std::string requested_type_name, std::string full_inst_path, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_object_wrapper> &m_resolve_type_name_by_inst__Vfuncrtn);
  ...
  public:
    uvmt_fifo_tb_uvm_pkg__03a__03auvm_default_factory(uvmt_fifo_tb__Syms* __restrict vlSymsp);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~uvmt_fifo_tb_uvm_pkg__03a__03auvm_default_factory();
};
