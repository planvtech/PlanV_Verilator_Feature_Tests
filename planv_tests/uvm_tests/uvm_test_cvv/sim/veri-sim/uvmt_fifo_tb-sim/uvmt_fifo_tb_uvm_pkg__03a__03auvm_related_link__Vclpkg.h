...
#ifndef VERILATED_UVMT_FIFO_TB_UVM_PKG__03A__03AUVM_RELATED_LINK__VCLPKG_H_
#define VERILATED_UVMT_FIFO_TB_UVM_PKG__03A__03AUVM_RELATED_LINK__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) uvmt_fifo_tb_uvm_pkg__03a__03auvm_related_link__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    uvmt_fifo_tb_uvm_pkg__03a__03auvm_related_link__Vclpkg();
    ~uvmt_fifo_tb_uvm_pkg__03a__03auvm_related_link__Vclpkg();
    void ctor(uvmt_fifo_tb__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(uvmt_fifo_tb_uvm_pkg__03a__03auvm_related_link__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_get_link(VlProcessRef vlProcess, uvmt_fifo_tb__Syms* __restrict vlSymsp, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_object> lhs, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_object> rhs, std::string name, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_related_link> &get_link__Vfuncrtn);
    void __VnoInFunc_get_type(uvmt_fifo_tb__Syms* __restrict vlSymsp, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_object_registry__pi210> &get_type__Vfuncrtn);
...
class uvmt_fifo_tb_uvm_pkg__03a__03auvm_related_link : public uvmt_fifo_tb_uvm_pkg__03a__03auvm_link_base {
  public:
  ...
  public:
    uvmt_fifo_tb_uvm_pkg__03a__03auvm_related_link(VlProcessRef vlProcess, uvmt_fifo_tb__Syms* __restrict vlSymsp, std::string name);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~uvmt_fifo_tb_uvm_pkg__03a__03auvm_related_link();
};
