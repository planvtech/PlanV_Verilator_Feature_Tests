...
#ifndef VERILATED_UVMT_FIFO_TB___024UNIT_H_
#define VERILATED_UVMT_FIFO_TB___024UNIT_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) uvmt_fifo_tb___024unit final {
  public:
    ...
    static VlUnpacked<std::string, 2> __Venumtab_enum_name115;
    ...
    // CONSTRUCTORS
    uvmt_fifo_tb___024unit();
    ~uvmt_fifo_tb___024unit();
    void ctor(uvmt_fifo_tb__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(uvmt_fifo_tb___024unit);
