...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer__Vclpkg::__VnoInFunc_get_type(uvmt_fifo_tb__Syms* __restrict vlSymsp, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_abstract_object_registry__pi8> &get_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer__Vclpkg::__VnoInFunc_get_type\n"); );
    // Locals
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_abstract_object_registry__pi8> __Vfunc_get__0__Vfuncout;
    // Body
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer__Vclpkg::__VnoInFunc_type_name(uvmt_fifo_tb__Syms* __restrict vlSymsp, std::string &type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer__Vclpkg::__VnoInFunc_type_name\n"); );
    // Body
    type_name__Vfuncrtn = "uvm_printer"s;
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer__Vclpkg::__VnoInFunc_set_default(uvmt_fifo_tb__Syms* __restrict vlSymsp, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer> printer) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer__Vclpkg::__VnoInFunc_set_default\n"); );
    // Locals
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__1__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_coreservice_t> coreservice;
    ...
    VL_NULL_CHECK(coreservice, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_printer.svh", 904)->__VnoInFunc_set_default_printer(vlSymsp, printer);
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer__Vclpkg::__VnoInFunc_get_default(VlProcessRef vlProcess, uvmt_fifo_tb__Syms* __restrict vlSymsp, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer> &get_default__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer__Vclpkg::__VnoInFunc_get_default\n"); );
    // Locals
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__3__Vfuncout;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer> __Vtask_get_default_printer__4__Vfuncout;
    // Body
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_coreservice_t> coreservice;
    ...
    VL_NULL_CHECK(coreservice, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_printer.svh", 910)->__VnoInFunc_get_default_printer(vlProcess, vlSymsp, __Vtask_get_default_printer__4__Vfuncout);
    get_default__Vfuncrtn = __Vtask_get_default_printer__4__Vfuncout;
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_object_type(VlProcessRef vlProcess, uvmt_fifo_tb__Syms* __restrict vlSymsp, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_object_wrapper> &get_object_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_object_type\n"); );
    // Locals
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_abstract_object_registry__pi8> __Vfunc_get__0__Vfuncout;
    // Body
    vlSymsp->TOP__uvm_pkg__03a__03auvm_abstract_object_registry__pi8__Vclpkg.__VnoInFunc_get(vlSymsp, __Vfunc_get__0__Vfuncout);
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_type_name(uvmt_fifo_tb__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_type_name\n"); );
    // Body
    get_type_name__Vfuncrtn = "uvm_printer"s;
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_knobs(uvmt_fifo_tb__Syms* __restrict vlSymsp, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03am_uvm_printer_knobs> &get_knobs__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_knobs\n"); );
    // Body
    get_knobs__Vfuncrtn = this->__PVT__knobs;
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_m_get_stack_size(uvmt_fifo_tb__Syms* __restrict vlSymsp, IData/*31:0*/ &m_get_stack_size__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_m_get_stack_size\n"); );
    // Body
    m_get_stack_size__Vfuncrtn = this->__PVT__m_element_stack.size();
}

uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer(VlProcessRef vlProcess, uvmt_fifo_tb__Syms* __restrict vlSymsp, std::string name)
    : uvmt_fifo_tb_uvm_pkg__03a__03auvm_policy(vlProcess, vlSymsp, name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::new\n"); );
    // Body
    _ctor_var_reset(vlSymsp);
    ;
    this->__PVT__knobs = VL_NEW(uvmt_fifo_tb_uvm_pkg__03a__03am_uvm_printer_knobs, vlSymsp);
    this->__VnoInFunc_flush(vlProcess, vlSymsp);
}

extern const VlWide<128>/*4095:0*/ uvmt_fifo_tb__ConstPool__CONST_h1958c06c_0;

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_print_field(VlProcessRef vlProcess, uvmt_fifo_tb__Syms* __restrict vlSymsp, std::string name, VlWide<128>/*4095:0*/ value, IData/*31:0*/ size, IData/*27:0*/ radix, CData/*7:0*/ scope_separator, std::string type_name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_print_field\n"); );
    // Locals
    ...
    __Vfunc_uvm_bitstream_to_string__5__unnamedblk3__DOT__unnamedblk4__DOT__idx = 0;
    {
        ...
        VL_SHIFTL_WWI(4096,4096,32, __Vtemp_2, uvmt_fifo_tb__ConstPool__CONST_h1958c06c_0, __Vfunc_uvm_bitstream_to_string__5__size);
        VL_SUB_W(128, __Vtemp_3, __Vtemp_2, uvmt_fifo_tb__ConstPool__CONST_h1958c06c_0);
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_print_field_int(VlProcessRef vlProcess, uvmt_fifo_tb__Syms* __restrict vlSymsp, std::string name, QData/*63:0*/ value, IData/*31:0*/ size, IData/*27:0*/ radix, CData/*7:0*/ scope_separator, std::string type_name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_print_field_int\n"); );
    // Locals
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_emit(VlProcessRef vlProcess, uvmt_fifo_tb__Syms* __restrict vlSymsp, std::string &emit__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_emit\n"); );
    // Locals
    ...
    if ((0U != ([&]() {
        ...
        __Vtask_uvm_report_error__20__filename = "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_printer.svh"s;
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_flush(VlProcessRef vlProcess, uvmt_fifo_tb__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_flush\n"); );
    // Locals
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer_element> __Vfunc_get_bottom_element__24__Vfuncout;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer_element> __Vfunc_get_bottom_element__25__Vfuncout;
    // Body
    IData/*31:0*/ unnamedblk41__DOT__i;
    unnamedblk41__DOT__i = 0;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer_element> element;
    ...
    VlQueue<VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer_element>> all_descendent_elements;
    ...
    if ((VlNull{} != element)) {
        VL_NULL_CHECK(element, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_printer.svh", 1010)->__VnoInFunc_get_children(vlSymsp, all_descendent_elements, 1U);
        ...
        while (VL_LTS_III(32, unnamedblk41__DOT__i, all_descendent_elements.size())) {
            ...
            VL_NULL_CHECK(all_descendent_elements.at(unnamedblk41__DOT__i), "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_printer.svh", 1013)->__VnoInFunc_clear_children(vlSymsp);
            unnamedblk41__DOT__i = ((IData)(1U) + unnamedblk41__DOT__i);
        }
        VL_NULL_CHECK(element, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_printer.svh", 1015)->__VnoInFunc_clear_children(vlSymsp);
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_set_name_enabled(uvmt_fifo_tb__Syms* __restrict vlSymsp, CData/*0:0*/ enabled) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_set_name_enabled\n"); );
    // Body
    VL_NULL_CHECK(this->__PVT__knobs, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_printer.svh", 1025)->__PVT__identifier 
        = enabled;
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_name_enabled(uvmt_fifo_tb__Syms* __restrict vlSymsp, CData/*0:0*/ &get_name_enabled__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_name_enabled\n"); );
    // Body
    get_name_enabled__Vfuncrtn = VL_NULL_CHECK(this->__PVT__knobs, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_printer.svh", 1028)
        ->__PVT__identifier;
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_set_type_name_enabled(uvmt_fifo_tb__Syms* __restrict vlSymsp, CData/*0:0*/ enabled) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_set_type_name_enabled\n"); );
    // Body
    VL_NULL_CHECK(this->__PVT__knobs, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_printer.svh", 1032)->__PVT__type_name 
        = enabled;
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_type_name_enabled(uvmt_fifo_tb__Syms* __restrict vlSymsp, CData/*0:0*/ &get_type_name_enabled__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_type_name_enabled\n"); );
    // Body
    get_type_name_enabled__Vfuncrtn = VL_NULL_CHECK(this->__PVT__knobs, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_printer.svh", 1035)
        ->__PVT__type_name;
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_set_size_enabled(uvmt_fifo_tb__Syms* __restrict vlSymsp, CData/*0:0*/ enabled) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_set_size_enabled\n"); );
    // Body
    VL_NULL_CHECK(this->__PVT__knobs, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_printer.svh", 1039)->__PVT__size 
        = enabled;
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_size_enabled(uvmt_fifo_tb__Syms* __restrict vlSymsp, CData/*0:0*/ &get_size_enabled__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_size_enabled\n"); );
    // Body
    get_size_enabled__Vfuncrtn = VL_NULL_CHECK(this->__PVT__knobs, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_printer.svh", 1042)
        ->__PVT__size;
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_set_id_enabled(uvmt_fifo_tb__Syms* __restrict vlSymsp, CData/*0:0*/ enabled) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_set_id_enabled\n"); );
    // Body
    VL_NULL_CHECK(this->__PVT__knobs, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_printer.svh", 1046)->__PVT__reference 
        = enabled;
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_id_enabled(uvmt_fifo_tb__Syms* __restrict vlSymsp, CData/*0:0*/ &get_id_enabled__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_id_enabled\n"); );
    // Body
    get_id_enabled__Vfuncrtn = VL_NULL_CHECK(this->__PVT__knobs, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_printer.svh", 1049)
        ->__PVT__reference;
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_set_radix_enabled(uvmt_fifo_tb__Syms* __restrict vlSymsp, CData/*0:0*/ enabled) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_set_radix_enabled\n"); );
    // Body
    VL_NULL_CHECK(this->__PVT__knobs, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_printer.svh", 1053)->__PVT__show_radix 
        = enabled;
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_radix_enabled(uvmt_fifo_tb__Syms* __restrict vlSymsp, CData/*0:0*/ &get_radix_enabled__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_radix_enabled\n"); );
    // Body
    get_radix_enabled__Vfuncrtn = VL_NULL_CHECK(this->__PVT__knobs, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_printer.svh", 1056)
        ->__PVT__show_radix;
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_set_radix_string(uvmt_fifo_tb__Syms* __restrict vlSymsp, IData/*27:0*/ radix, std::string prefix) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_set_radix_string\n"); );
    // Locals
    ...
    if ((0x02000000U == radix)) {
        VL_NULL_CHECK(this->__PVT__knobs, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_printer.svh", 1060)->__PVT__dec_radix 
            = prefix;
    } else if ((0x01000000U == radix)) {
        VL_NULL_CHECK(this->__PVT__knobs, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_printer.svh", 1061)->__PVT__bin_radix 
            = prefix;
    } else if ((0x06000000U == radix)) {
        VL_NULL_CHECK(this->__PVT__knobs, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_printer.svh", 1062)->__PVT__oct_radix 
            = prefix;
    } else if ((0x03000000U == radix)) {
        VL_NULL_CHECK(this->__PVT__knobs, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_printer.svh", 1063)->__PVT__unsigned_radix 
            = prefix;
    } else if ((0x07000000U == radix)) {
        VL_NULL_CHECK(this->__PVT__knobs, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_printer.svh", 1064)->__PVT__hex_radix 
            = prefix;
    } else if ((0U != ([&]() {
        ...
        __Vtask_uvm_report_warning__33__filename = "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_printer.svh"s;
        ...
        VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_warning__Vstatic__cs, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_globals.svh", 155)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__35__Vfuncout);
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_radix_string(uvmt_fifo_tb__Syms* __restrict vlSymsp, IData/*27:0*/ radix, std::string &get_radix_string__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_radix_string\n"); );
    // Body
    get_radix_string__Vfuncrtn = ((0x02000000U == radix)
                                   ? VL_NULL_CHECK(this->__PVT__knobs, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_printer.svh", 1068)
                                  ->__PVT__dec_radix
                                   : ((0x01000000U 
                                       == radix) ? VL_NULL_CHECK(this->__PVT__knobs, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_printer.svh", 1069)
                                      ->__PVT__bin_radix
                                       : ((0x06000000U 
                                           == radix)
                                           ? VL_NULL_CHECK(this->__PVT__knobs, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_printer.svh", 1070)
                                          ->__PVT__oct_radix
                                           : ((0x03000000U 
                                               == radix)
                                               ? VL_NULL_CHECK(this->__PVT__knobs, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_printer.svh", 1071)
                                              ->__PVT__unsigned_radix
                                               : ((0x07000000U 
                                                   == radix)
                                                   ? VL_NULL_CHECK(this->__PVT__knobs, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_printer.svh", 1072)
                                                  ->__PVT__hex_radix
                                                   : ""s)))));
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_set_default_radix(uvmt_fifo_tb__Syms* __restrict vlSymsp, IData/*27:0*/ radix) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_set_default_radix\n"); );
    // Body
    VL_NULL_CHECK(this->__PVT__knobs, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_printer.svh", 1077)->__PVT__default_radix 
        = radix;
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_default_radix(uvmt_fifo_tb__Syms* __restrict vlSymsp, IData/*27:0*/ &get_default_radix__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_default_radix\n"); );
    // Body
    get_default_radix__Vfuncrtn = VL_NULL_CHECK(this->__PVT__knobs, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_printer.svh", 1080)
        ->__PVT__default_radix;
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_set_root_enabled(uvmt_fifo_tb__Syms* __restrict vlSymsp, CData/*0:0*/ enabled) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_set_root_enabled\n"); );
    // Body
    VL_NULL_CHECK(this->__PVT__knobs, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_printer.svh", 1084)->__PVT__show_root 
        = enabled;
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_root_enabled(uvmt_fifo_tb__Syms* __restrict vlSymsp, CData/*0:0*/ &get_root_enabled__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_root_enabled\n"); );
    // Body
    get_root_enabled__Vfuncrtn = VL_NULL_CHECK(this->__PVT__knobs, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_printer.svh", 1087)
        ->__PVT__show_root;
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_set_recursion_policy(uvmt_fifo_tb__Syms* __restrict vlSymsp, IData/*27:0*/ policy) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_set_recursion_policy\n"); );
    // Body
    VL_NULL_CHECK(this->__PVT__knobs, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_printer.svh", 1091)->__PVT__recursion_policy 
        = policy;
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_recursion_policy(uvmt_fifo_tb__Syms* __restrict vlSymsp, IData/*27:0*/ &get_recursion_policy__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_recursion_policy\n"); );
    // Body
    get_recursion_policy__Vfuncrtn = VL_NULL_CHECK(this->__PVT__knobs, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_printer.svh", 1094)
        ->__PVT__recursion_policy;
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_set_max_depth(uvmt_fifo_tb__Syms* __restrict vlSymsp, IData/*31:0*/ depth) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_set_max_depth\n"); );
    // Body
    VL_NULL_CHECK(this->__PVT__knobs, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_printer.svh", 1098)->__PVT__depth 
        = depth;
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_max_depth(uvmt_fifo_tb__Syms* __restrict vlSymsp, IData/*31:0*/ &get_max_depth__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_max_depth\n"); );
    // Body
    get_max_depth__Vfuncrtn = VL_NULL_CHECK(this->__PVT__knobs, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_printer.svh", 1101)
        ->__PVT__depth;
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_set_file(uvmt_fifo_tb__Syms* __restrict vlSymsp, IData/*31:0*/ fl) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_set_file\n"); );
    // Body
    VL_NULL_CHECK(this->__PVT__knobs, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_printer.svh", 1105)->__PVT__mcd 
        = fl;
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_file(uvmt_fifo_tb__Syms* __restrict vlSymsp, IData/*31:0*/ &get_file__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_file\n"); );
    // Body
    get_file__Vfuncrtn = VL_NULL_CHECK(this->__PVT__knobs, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_printer.svh", 1108)
        ->__PVT__mcd;
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_set_line_prefix(uvmt_fifo_tb__Syms* __restrict vlSymsp, std::string prefix) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_set_line_prefix\n"); );
    // Body
    VL_NULL_CHECK(this->__PVT__knobs, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_printer.svh", 1112)->__PVT__prefix 
        = prefix;
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_line_prefix(uvmt_fifo_tb__Syms* __restrict vlSymsp, std::string &get_line_prefix__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_line_prefix\n"); );
    // Body
    get_line_prefix__Vfuncrtn = VL_NULL_CHECK(this->__PVT__knobs, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_printer.svh", 1115)
        ->__PVT__prefix;
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_set_begin_elements(uvmt_fifo_tb__Syms* __restrict vlSymsp, IData/*31:0*/ elements) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_set_begin_elements\n"); );
    // Body
    VL_NULL_CHECK(this->__PVT__knobs, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_printer.svh", 1119)->__PVT__begin_elements 
        = elements;
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_begin_elements(uvmt_fifo_tb__Syms* __restrict vlSymsp, IData/*31:0*/ &get_begin_elements__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_begin_elements\n"); );
    // Body
    get_begin_elements__Vfuncrtn = VL_NULL_CHECK(this->__PVT__knobs, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_printer.svh", 1122)
        ->__PVT__begin_elements;
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_set_end_elements(uvmt_fifo_tb__Syms* __restrict vlSymsp, IData/*31:0*/ elements) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_set_end_elements\n"); );
    // Body
    VL_NULL_CHECK(this->__PVT__knobs, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_printer.svh", 1126)->__PVT__end_elements 
        = elements;
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_end_elements(uvmt_fifo_tb__Syms* __restrict vlSymsp, IData/*31:0*/ &get_end_elements__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_end_elements\n"); );
    // Body
    get_end_elements__Vfuncrtn = VL_NULL_CHECK(this->__PVT__knobs, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_printer.svh", 1129)
        ->__PVT__end_elements;
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_bottom_element(uvmt_fifo_tb__Syms* __restrict vlSymsp, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer_element> &get_bottom_element__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_bottom_element\n"); );
    // Body
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_top_element(uvmt_fifo_tb__Syms* __restrict vlSymsp, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer_element> &get_top_element__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_top_element\n"); );
    // Body
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_push_element(VlProcessRef vlProcess, uvmt_fifo_tb__Syms* __restrict vlSymsp, std::string name, std::string type_name, std::string size, std::string value) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_push_element\n"); );
    // Locals
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer_element> __Vfunc_get_unused_element__37__Vfuncout;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer_element> __Vfunc_get_top_element__38__Vfuncout;
    // Body
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer_element> element;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer_element> parent;
    ...
    VL_NULL_CHECK(element, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_printer.svh", 1166)->__VnoInFunc_set(vlSymsp, name, type_name, size, value);
    if ((VlNull{} != parent)) {
        VL_NULL_CHECK(parent, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_printer.svh", 1167)->__VnoInFunc_add_child(vlSymsp, element);
    }
    this->__PVT__m_element_stack.push_back(element);
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_pop_element(uvmt_fifo_tb__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_pop_element\n"); );
    // Body
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_unused_element(VlProcessRef vlProcess, uvmt_fifo_tb__Syms* __restrict vlSymsp, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer_element> &get_unused_element__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_unused_element\n"); );
    // Body
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer_element> element;
    element = (VL_LTS_III(32, 0U, this->__PVT__m_recycled_elements.size())
                ? this->__PVT__m_recycled_elements.pop_back()
                : VL_NEW(uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer_element, vlProcess, vlSymsp, ""s));
    get_unused_element__Vfuncrtn = element;
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_print_array_header(VlProcessRef vlProcess, uvmt_fifo_tb__Syms* __restrict vlSymsp, std::string name, IData/*31:0*/ size, std::string arraytype, CData/*7:0*/ scope_separator) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_print_array_header\n"); );
    // Body
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_print_array_footer(uvmt_fifo_tb__Syms* __restrict vlSymsp, IData/*31:0*/ size) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_print_array_footer\n"); );
    // Body
    this->__VnoInFunc_pop_element(vlSymsp);
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_print_array_range(VlProcessRef vlProcess, uvmt_fifo_tb__Syms* __restrict vlSymsp, IData/*31:0*/ min, IData/*31:0*/ max) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_print_array_range\n"); );
    // Body
    std::string tmpstr;
    {
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_print_object_header(VlProcessRef vlProcess, uvmt_fifo_tb__Syms* __restrict vlSymsp, std::string name, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_object> value, CData/*7:0*/ scope_separator) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_print_object_header\n"); );
    // Locals
    ...
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_object> __Vfunc_uvm_object_value_str__48__v;
    ...
    this->__VnoInFunc_push_element(vlProcess, vlSymsp, name, 
                                   VL_CVT_PACK_STR_NN(
                                                      ((VlNull{} 
                                                        ...
                                                        ? 
                                                       ([&]() {
                        VL_NULL_CHECK(value, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_printer.svh", 1245)
                            ...
                            = value;
                        {
                            ...
                            __Vfunc_uvm_object_value_str__48__Vfuncout 
                                = VL_SFORMATF_N_NX("%0d",0,
                                                   32,
                                                   ([&]() {
                                            VL_NULL_CHECK(__Vfunc_uvm_object_value_str__48__v, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_misc.svh", 198)
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_print_object(VlProcessRef vlProcess, uvmt_fifo_tb__Syms* __restrict vlSymsp, std::string name, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_object> value, CData/*7:0*/ scope_separator) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_print_object\n"); );
    // Locals
    ...
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_component> __Vtask_get_child__58__Vfuncout;
    IData/*31:0*/ __Vtask_get_next_child__60__Vfuncout;
    __Vtask_get_next_child__60__Vfuncout = 0;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_field_op> __Vfunc_m_get_available_op__61__Vfuncout;
    CData/*0:0*/ __Vtask_user_hook_enabled__64__Vfuncout;
    __Vtask_user_hook_enabled__64__Vfuncout = 0;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_object> __Vtask_pop_active_object__68__Vfuncout;
    // Body
    std::string unnamedblk42__DOT__name;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_component> comp;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_component> child_comp;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_field_op> field_op;
    ...
    if ((((VlNull{} == value) | (0x00040000U == recursion_policy)) 
        ...
        if (VL_CAST_DYNAMIC(value, comp)) {
            if ((0U != ([&]() {
                            VL_NULL_CHECK(comp, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_printer.svh", 1276)
                ...
                do {
                    VL_NULL_CHECK(comp, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_printer.svh", 1278)->__VnoInFunc_get_child(vlProcess, vlSymsp, unnamedblk42__DOT__name, __Vtask_get_child__58__Vfuncout);
                    child_comp = __Vtask_get_child__58__Vfuncout;
                    if (VL_NULL_CHECK(child_comp, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_printer.svh", 1279)
                        ->__PVT__print_enabled) {
                        this->__VnoInFunc_print_object(vlProcess, vlSymsp, unnamedblk42__DOT__name, child_comp, 0x2eU);
                    }
                } while ((0U != ([&]() {
                                VL_NULL_CHECK(comp, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_printer.svh", 1281)
        ...
        VL_NULL_CHECK(field_op, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_printer.svh", 1285)->__VnoInFunc_set(vlProcess, vlSymsp, 0x00000010U, 
                                                                                VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer>{this}, VlNull{});
        VL_NULL_CHECK(value, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_printer.svh", 1286)->__VnoInFunc_do_execute_op(vlProcess, vlSymsp, field_op);
        if (([&]() {
                    VL_NULL_CHECK(field_op, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_printer.svh", 1287)
            ...
            VL_NULL_CHECK(value, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_printer.svh", 1288)->__VnoInFunc_do_print(vlProcess, vlSymsp, 
                                                                                VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer>{this});
        }
        VL_NULL_CHECK(field_op, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_printer.svh", 1289)->__VnoInFunc_m_recycle(vlSymsp);
        this->__VnoInFunc_pop_element(vlSymsp);
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_istop(uvmt_fifo_tb__Syms* __restrict vlSymsp, CData/*0:0*/ &istop__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_istop\n"); );
    // Locals
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_print_generic(VlProcessRef vlProcess, uvmt_fifo_tb__Syms* __restrict vlSymsp, std::string name, std::string type_name, IData/*31:0*/ size, std::string value, CData/*7:0*/ scope_separator) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_print_generic\n"); );
    // Body
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_print_generic_element(VlProcessRef vlProcess, uvmt_fifo_tb__Syms* __restrict vlSymsp, std::string name, std::string type_name, std::string size, std::string value) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_print_generic_element\n"); );
    // Body
    this->__VnoInFunc_push_element(vlProcess, vlSymsp, name, type_name, size, value);
    this->__VnoInFunc_pop_element(vlSymsp);
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_print_time(VlProcessRef vlProcess, uvmt_fifo_tb__Syms* __restrict vlSymsp, std::string name, QData/*63:0*/ value, CData/*7:0*/ scope_separator) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_print_time\n"); );
    // Body
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_print_string(VlProcessRef vlProcess, uvmt_fifo_tb__Syms* __restrict vlSymsp, std::string name, std::string value, CData/*7:0*/ scope_separator) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_print_string\n"); );
    // Body
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_object_printed(uvmt_fifo_tb__Syms* __restrict vlSymsp, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_object> value, IData/*27:0*/ recursion, IData/*31:0*/ &object_printed__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_object_printed\n"); );
    // Body
    {
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_print_real(uvmt_fifo_tb__Syms* __restrict vlSymsp, std::string name, double value, CData/*7:0*/ scope_separator) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_print_real\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_index_string(uvmt_fifo_tb__Syms* __restrict vlSymsp, IData/*31:0*/ index, std::string name, std::string &index_string__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_index_string\n"); );
    // Body
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_randomize(uvmt_fifo_tb__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc_randomize\n"); );
    // Locals
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc___Vsetup_constraints(uvmt_fifo_tb__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc___Vsetup_constraints\n"); );
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc___VBasicRand(uvmt_fifo_tb__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::__VnoInFunc___VBasicRand\n"); );
    // Body
    __VBasicRand__Vfuncrtn = 1U;
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::_ctor_var_reset(uvmt_fifo_tb__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::_ctor_var_reset\n"); );
    // Body
...
uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::~uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer() {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::~\n"); );
}

std::string VL_TO_STRING(const VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer::to_string_middle\n"); );
    // Body
    std::string out;
    ...
    out += ", "+ uvmt_fifo_tb_uvm_pkg__03a__03auvm_policy::to_string_middle();
    return (out);
}
