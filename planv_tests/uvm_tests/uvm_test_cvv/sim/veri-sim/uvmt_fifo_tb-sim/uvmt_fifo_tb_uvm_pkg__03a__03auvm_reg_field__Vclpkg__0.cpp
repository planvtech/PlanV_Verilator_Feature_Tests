...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field__Vclpkg::__VnoInFunc_get_type(uvmt_fifo_tb__Syms* __restrict vlSymsp, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_object_registry__pi197> &get_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field__Vclpkg::__VnoInFunc_get_type\n"); );
    // Locals
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_object_registry__pi197> __Vfunc_get__0__Vfuncout;
    // Body
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field__Vclpkg::__VnoInFunc_type_name(uvmt_fifo_tb__Syms* __restrict vlSymsp, std::string &type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field__Vclpkg::__VnoInFunc_type_name\n"); );
    // Body
    type_name__Vfuncrtn = "uvm_reg_field"s;
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field__Vclpkg::__VnoInFunc_get_max_size(uvmt_fifo_tb__Syms* __restrict vlSymsp, IData/*31:0*/ &get_max_size__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field__Vclpkg::__VnoInFunc_get_max_size\n"); );
    // Body
    get_max_size__Vfuncrtn = this->__PVT__m_max_size;
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field__Vclpkg::__VnoInFunc_define_access(uvmt_fifo_tb__Syms* __restrict vlSymsp, std::string name, CData/*0:0*/ &define_access__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field__Vclpkg::__VnoInFunc_define_access\n"); );
    // Locals
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field__Vclpkg::__VnoInFunc_m_predefine_policies(uvmt_fifo_tb__Syms* __restrict vlSymsp, CData/*0:0*/ &m_predefine_policies__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field__Vclpkg::__VnoInFunc_m_predefine_policies\n"); );
    // Locals
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_get_object_type(VlProcessRef vlProcess, uvmt_fifo_tb__Syms* __restrict vlSymsp, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_object_wrapper> &get_object_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_get_object_type\n"); );
    // Locals
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_object_registry__pi197> __Vfunc_get__0__Vfuncout;
    // Body
    vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__pi197__Vclpkg.__VnoInFunc_get(vlSymsp, __Vfunc_get__0__Vfuncout);
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_create(VlProcessRef vlProcess, uvmt_fifo_tb__Syms* __restrict vlSymsp, std::string name, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_object> &create__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_create\n"); );
    // Body
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field> tmp;
    tmp = ((""s == name) ? VL_NEW(uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field, vlProcess, vlSymsp, "uvm_reg_field"s)
            : VL_NEW(uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field, vlProcess, vlSymsp, name));
    create__Vfuncrtn = tmp;
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_get_type_name(uvmt_fifo_tb__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_get_type_name\n"); );
    // Body
    get_type_name__Vfuncrtn = "uvm_reg_field"s;
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_pre_write(uvmt_fifo_tb__Syms* __restrict vlSymsp, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_item> rw) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_pre_write\n"); );
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_post_write(uvmt_fifo_tb__Syms* __restrict vlSymsp, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_item> rw) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_post_write\n"); );
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_pre_read(uvmt_fifo_tb__Syms* __restrict vlSymsp, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_item> rw) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_pre_read\n"); );
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_post_read(uvmt_fifo_tb__Syms* __restrict vlSymsp, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_item> rw) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_post_read\n"); );
}

uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field(VlProcessRef vlProcess, uvmt_fifo_tb__Syms* __restrict vlSymsp, std::string name)
    : uvmt_fifo_tb_uvm_pkg__03a__03auvm_object(vlProcess, vlSymsp, name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::new\n"); );
    // Body
    _ctor_var_reset(vlSymsp);
    IData/*31:0*/ unnamedblk2_1__DOT__i;
    unnamedblk2_1__DOT__i = 0;
    ;
    uvmt_fifo_tb_uvm_pkg__03a__03auvm_void::__Vrandmode.resize(1U);
    unnamedblk2_1__DOT__i = 0U;
    while ((unnamedblk2_1__DOT__i < uvmt_fifo_tb_uvm_pkg__03a__03auvm_void::__Vrandmode.size())) {
        uvmt_fifo_tb_uvm_pkg__03a__03auvm_void::__Vrandmode.atWrite(unnamedblk2_1__DOT__i) = 1U;
        unnamedblk2_1__DOT__i = ((IData)(1U) + unnamedblk2_1__DOT__i);
    }
    uvmt_fifo_tb_uvm_pkg__03a__03auvm_void::__PVT__constraint.write_var(this->__PVT__value, 0x0000000000000040ULL, 
                                                                        "value", 0ULL, 0ULL);
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_configure(uvmt_fifo_tb__Syms* __restrict vlSymsp, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg> parent, IData/*31:0*/ size, IData/*31:0*/ lsb_pos, std::string access, CData/*0:0*/ __SYM__volatile, QData/*63:0*/ reset, CData/*0:0*/ has_reset, CData/*0:0*/ is_rand, CData/*0:0*/ individually_accessible) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_configure\n"); );
    // Locals
    ...
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__5__Vfuncout;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_root> __Vtask_get_root__6__Vfuncout;
    ...
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__16__Vfuncout;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_root> __Vtask_get_root__17__Vfuncout;
    ...
    if ((0U == size)) {
        if ((0U != ([&]() {
            ...
            __Vtask_uvm_report_error__8__filename = "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh"s;
    ...
    VL_NULL_CHECK(this->__PVT__m_parent, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 432)->__VnoInFunc_add_field(vlSymsp, 
                                                                                VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field>{this});
    if ((! vlSymsp->TOP__uvm_pkg__03a__03auvm_reg_field__Vclpkg.__PVT__m_policy_names.exists(this->__PVT__m_access))) {
        if ((0U != ([&]() {
            ...
            __Vtask_uvm_report_error__19__filename = "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh"s;
            ...
            VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_error__Vstatic__cs, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_globals.svh", 174)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__22__Vfuncout);
            vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_error__Vstatic__top 
    ...
    if ((1U & (~ (IData)(is_rand)))) {
        uvmt_fifo_tb_uvm_pkg__03a__03auvm_void::__Vrandmode.atWrite(0U) = 0U;
    }
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_get_parent(uvmt_fifo_tb__Syms* __restrict vlSymsp, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg> &get_parent__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_get_parent\n"); );
    // Body
    get_parent__Vfuncrtn = this->__PVT__m_parent;
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_get_full_name(VlProcessRef vlProcess, uvmt_fifo_tb__Syms* __restrict vlSymsp, std::string &get_full_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_get_full_name\n"); );
    // Locals
    ...
    get_full_name__Vfuncrtn = VL_CONCATN_NNN(VL_CONCATN_NNN(
                                                            ([&]() {
                    VL_NULL_CHECK(this->__PVT__m_parent, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 468)
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_get_register(uvmt_fifo_tb__Syms* __restrict vlSymsp, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg> &get_register__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_get_register\n"); );
    // Body
    get_register__Vfuncrtn = this->__PVT__m_parent;
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_get_lsb_pos(uvmt_fifo_tb__Syms* __restrict vlSymsp, IData/*31:0*/ &get_lsb_pos__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_get_lsb_pos\n"); );
    // Body
    get_lsb_pos__Vfuncrtn = this->__PVT__m_lsb;
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_get_n_bits(uvmt_fifo_tb__Syms* __restrict vlSymsp, IData/*31:0*/ &get_n_bits__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_get_n_bits\n"); );
    // Body
    get_n_bits__Vfuncrtn = this->__PVT__m_size;
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_is_known_access(VlProcessRef vlProcess, uvmt_fifo_tb__Syms* __restrict vlSymsp, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_map> map, CData/*0:0*/ &is_known_access__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_is_known_access\n"); );
    // Locals
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_get_access(VlProcessRef vlProcess, uvmt_fifo_tb__Syms* __restrict vlSymsp, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_map> map, std::string &get_access__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_get_access\n"); );
    // Locals
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_map> __Vfunc_backdoor__27__Vfuncout;
    ...
    // Body
    std::string __VCase_h9139f5d2__0;
    std::string field_access;
    {
        ...
        if (([&]() {
                    VL_NULL_CHECK(this->__PVT__m_parent, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 523)
             ->__VnoInFunc_get_rights(vlProcess, vlSymsp, map, __Vtask_get_rights__28__Vfuncout);
                    __VCase_h9139f5d2__0 = __Vtask_get_rights__28__Vfuncout;
                }(), 1U)) {
            if (("RW"s == __VCase_h9139f5d2__0)) {
                get_access__Vfuncrtn = field_access;
                goto __Vlabel0;
            } else if (("RO"s == __VCase_h9139f5d2__0)) {
            ...
            } else if (("WO"s == __VCase_h9139f5d2__0)) {
                if ((((((((((("RW"s == field_access) 
                             || ("WRC"s == field_access)) 
                            || ("WRS"s == field_access)) 
                           | ("W1SRC"s == field_access)) 
                ...
                if ((0U != ([&]() {
                    ...
                    __Vtask_uvm_report_warning__33__filename = "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh"s;
                        ...
                        = VL_CVT_PACK_STR_NN(VL_CONCATN_NNN(
                                                            VL_CONCATN_NNN(
                                                                           VL_CONCATN_NNN(
                                                                                ...
                                                                                ([&]() {
                                                                VL_NULL_CHECK(this->__PVT__m_parent, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 570)
                                                        ...
                                                        this->__VnoInFunc_get_name(vlSymsp, __Vfunc_get_name__35__Vfuncout);
                                                                                ...
                                                                                ([&]() {
                                                VL_NULL_CHECK(map, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 570)
                    ...
                    VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_warning__Vstatic__cs, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_globals.svh", 155)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__39__Vfuncout);
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_set_access(uvmt_fifo_tb__Syms* __restrict vlSymsp, std::string mode, std::string &set_access__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_set_access\n"); );
    // Locals
    ...
    if ((! vlSymsp->TOP__uvm_pkg__03a__03auvm_reg_field__Vclpkg.__PVT__m_policy_names.exists(this->__PVT__m_access))) {
        if ((0U != ([&]() {
            ...
            __Vtask_uvm_report_error__45__filename = "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh"s;
            ...
            VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_error__Vstatic__cs, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_globals.svh", 174)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__47__Vfuncout);
            vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_error__Vstatic__top 
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_set_volatility(uvmt_fifo_tb__Syms* __restrict vlSymsp, CData/*0:0*/ __SYM__volatile) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_set_volatility\n"); );
    // Body
    this->__PVT__m_volatile = __SYM__volatile;
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_is_volatile(uvmt_fifo_tb__Syms* __restrict vlSymsp, CData/*0:0*/ &is_volatile__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_is_volatile\n"); );
    // Body
    is_volatile__Vfuncrtn = this->__PVT__m_volatile;
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_XpredictX(VlProcessRef vlProcess, uvmt_fifo_tb__Syms* __restrict vlSymsp, QData/*63:0*/ cur_val, QData/*63:0*/ wr_val, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_map> map, QData/*63:0*/ &XpredictX__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_XpredictX\n"); );
    // Locals
    ...
    // Body
    std::string __VCase_hb8392a93__0;
    QData/*63:0*/ mask;
    mask = 0;
    {
        ...
        if (([&]() {
                    ...
                    __VCase_hb8392a93__0 = __Vfunc_get_access__49__Vfuncout;
                }(), (((((((("RO"s == __VCase_hb8392a93__0) 
                            | ("RW"s == __VCase_hb8392a93__0)) 
                           | ("RC"s == __VCase_hb8392a93__0)) 
                          | ("RS"s == __VCase_hb8392a93__0)) 
                         | ("WC"s == __VCase_hb8392a93__0)) 
                        | ("WS"s == __VCase_hb8392a93__0)) 
                       | ("WRC"s == __VCase_hb8392a93__0)) 
                      | ("WRS"s == __VCase_hb8392a93__0)))) {
            if (("RO"s == __VCase_hb8392a93__0)) {
                XpredictX__Vfuncrtn = cur_val;
                goto __Vlabel0;
            } else if (("RW"s == __VCase_hb8392a93__0)) {
                XpredictX__Vfuncrtn = wr_val;
                goto __Vlabel0;
            } else if (("RC"s == __VCase_hb8392a93__0)) {
                XpredictX__Vfuncrtn = cur_val;
                goto __Vlabel0;
            } else if (("RS"s == __VCase_hb8392a93__0)) {
                XpredictX__Vfuncrtn = cur_val;
                goto __Vlabel0;
            } else if (("WC"s == __VCase_hb8392a93__0)) {
                XpredictX__Vfuncrtn = 0ULL;
                goto __Vlabel0;
            } else if (("WS"s == __VCase_hb8392a93__0)) {
                XpredictX__Vfuncrtn = mask;
                goto __Vlabel0;
            } else if (("WRC"s == __VCase_hb8392a93__0)) {
                XpredictX__Vfuncrtn = wr_val;
                goto __Vlabel0;
            } else {
                XpredictX__Vfuncrtn = wr_val;
        ...
        } else if ((((((((("WSRC"s == __VCase_hb8392a93__0) 
                          | ("WCRS"s == __VCase_hb8392a93__0)) 
                         | ("W1C"s == __VCase_hb8392a93__0)) 
                        | ("W1S"s == __VCase_hb8392a93__0)) 
                       | ("W1T"s == __VCase_hb8392a93__0)) 
                      | ("W0C"s == __VCase_hb8392a93__0)) 
                     | ("W0S"s == __VCase_hb8392a93__0)) 
                    | ("W0T"s == __VCase_hb8392a93__0))) {
            if (("WSRC"s == __VCase_hb8392a93__0)) {
                XpredictX__Vfuncrtn = mask;
                goto __Vlabel0;
            } else if (("WCRS"s == __VCase_hb8392a93__0)) {
                XpredictX__Vfuncrtn = 0ULL;
                goto __Vlabel0;
            } else if (("W1C"s == __VCase_hb8392a93__0)) {
                XpredictX__Vfuncrtn = (cur_val & (~ wr_val));
                goto __Vlabel0;
            } else if (("W1S"s == __VCase_hb8392a93__0)) {
                XpredictX__Vfuncrtn = (cur_val | wr_val);
                goto __Vlabel0;
            } else if (("W1T"s == __VCase_hb8392a93__0)) {
                XpredictX__Vfuncrtn = (cur_val ^ wr_val);
                goto __Vlabel0;
            } else if (("W0C"s == __VCase_hb8392a93__0)) {
                XpredictX__Vfuncrtn = (cur_val & wr_val);
                goto __Vlabel0;
            } else if (("W0S"s == __VCase_hb8392a93__0)) {
                XpredictX__Vfuncrtn = (cur_val | ((~ wr_val) 
                                                  & mask));
                goto __Vlabel0;
            } else {
        ...
        } else if ((((((((("W1SRC"s == __VCase_hb8392a93__0) 
                          | ("W1CRS"s == __VCase_hb8392a93__0)) 
                         | ("W0SRC"s == __VCase_hb8392a93__0)) 
                        | ("W0CRS"s == __VCase_hb8392a93__0)) 
                       | ("WO"s == __VCase_hb8392a93__0)) 
                      | ("WOC"s == __VCase_hb8392a93__0)) 
                     | ("WOS"s == __VCase_hb8392a93__0)) 
                    | ("W1"s == __VCase_hb8392a93__0))) {
            if (("W1SRC"s == __VCase_hb8392a93__0)) {
                XpredictX__Vfuncrtn = (cur_val | wr_val);
                goto __Vlabel0;
            } else if (("W1CRS"s == __VCase_hb8392a93__0)) {
                XpredictX__Vfuncrtn = (cur_val & (~ wr_val));
                goto __Vlabel0;
            } else if (("W0SRC"s == __VCase_hb8392a93__0)) {
                XpredictX__Vfuncrtn = (cur_val | ((~ wr_val) 
                                                  & mask));
                goto __Vlabel0;
            } else if (("W0CRS"s == __VCase_hb8392a93__0)) {
                XpredictX__Vfuncrtn = (cur_val & wr_val);
                goto __Vlabel0;
            } else if (("WO"s == __VCase_hb8392a93__0)) {
                XpredictX__Vfuncrtn = wr_val;
                goto __Vlabel0;
            } else if (("WOC"s == __VCase_hb8392a93__0)) {
                XpredictX__Vfuncrtn = 0ULL;
                goto __Vlabel0;
            } else if (("WOS"s == __VCase_hb8392a93__0)) {
                XpredictX__Vfuncrtn = mask;
                goto __Vlabel0;
            } else {
        ...
        } else if (("WO1"s == __VCase_hb8392a93__0)) {
            XpredictX__Vfuncrtn = ((IData)(this->__PVT__m_written)
                                    ? cur_val : wr_val);
            goto __Vlabel0;
        } else if (("NOACCESS"s == __VCase_hb8392a93__0)) {
            XpredictX__Vfuncrtn = cur_val;
            goto __Vlabel0;
        } else {
            XpredictX__Vfuncrtn = wr_val;
        ...
        if ((0U != ([&]() {
            ...
            vlSymsp->TOP__uvm_pkg.__VnoInFunc_uvm_report_fatal_TOP__uvm_pkg(vlProcess, vlSymsp, "RegModel"s, "uvm_reg_field::XpredictX(): Internal error"s, 0U, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh"s, 0x000002b3U, ""s, 1U);
        }
        XpredictX__Vfuncrtn = 0ULL;
        __Vlabel0: ;
    }
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_predict(uvmt_fifo_tb__Syms* __restrict vlSymsp, QData/*63:0*/ value, CData/*7:0*/ be, IData/*31:0*/ kind, IData/*31:0*/ path, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_map> map, std::string fname, IData/*31:0*/ lineno, CData/*0:0*/ &predict__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_predict\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    ...
    VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 707)->__PVT__value.atWrite(0U) 
        = value;
    VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 708)->__PVT__path 
        = path;
    VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 709)->__PVT__map 
        = map;
    VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 710)->__PVT__fname 
        = fname;
    VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 711)->__PVT__lineno 
        = lineno;
    this->__VnoInFunc_do_predict(vlProcess, vlSymsp, rw, kind, (IData)(be));
    predict__Vfuncrtn = ((1U == VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 713)
                          ->__PVT__status) ? 0U : 1U);
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_do_predict(VlProcessRef vlProcess, uvmt_fifo_tb__Syms* __restrict vlSymsp, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_item> rw, IData/*31:0*/ kind, CData/*7:0*/ be) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_do_predict\n"); );
    // Locals
    QData/*63:0*/ __Vfunc_XpredictX__58__Vfuncout;
    __Vfunc_XpredictX__58__Vfuncout = 0;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_cbs> __Vtask_first__59__Vfuncout;
    QData/*63:0*/ __Vtask_post_predict__60__value;
    __Vtask_post_predict__60__value = 0;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_cbs> __Vtask_next__61__Vfuncout;
    std::string __Vfunc_get_access__63__Vfuncout;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_cbs> __Vtask_first__64__Vfuncout;
    QData/*63:0*/ __Vtask_post_predict__65__value;
    __Vtask_post_predict__65__value = 0;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_cbs> __Vtask_next__66__Vfuncout;
    ...
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__69__Vfuncout;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_root> __Vtask_get_root__70__Vfuncout;
    ...
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__75__Vfuncout;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_root> __Vtask_get_root__76__Vfuncout;
    // Body
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_callback_iter__pi189> unnamedblk278__DOT__cbs;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_cbs> unnamedblk278__DOT__unnamedblk279__DOT__cb;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_callback_iter__pi189> unnamedblk280__DOT__cbs;
    std::string unnamedblk280__DOT__unnamedblk281__DOT__acc;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_cbs> unnamedblk280__DOT__unnamedblk282__DOT__cb;
    QData/*63:0*/ field_val;
    field_val = 0;
    {
        field_val = (VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 723)
                     ->__PVT__value.at(0U) & (VL_SHIFTL_QQI(64,64,32, 1ULL, this->__PVT__m_size) 
                                              - 1ULL));
        if ((1U != VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 725)
             ->__PVT__status)) {
            VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 726)->__PVT__status = 0U;
        }
        if ((1U & (~ (IData)(be)))) {
            goto __Vlabel0;
        }
        this->__PVT__m_fname = VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 732)
            ->__PVT__fname;
        this->__PVT__m_lineno = VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 733)
            ->__PVT__lineno;
        if ((2U == kind)) {
            unnamedblk278__DOT__cbs = VL_NEW(uvmt_fifo_tb_uvm_pkg__03a__03auvm_callback_iter__pi189, vlSymsp, 
                                             VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field>{this});
            if (((0U == VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 741)
                  ->__PVT__path) || (2U == VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 741)
                                     ->__PVT__path))) {
                this->__VnoInFunc_XpredictX(vlProcess, vlSymsp, this->__PVT__m_mirrored, field_val, VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 742)
                                            ->__PVT__map, __Vfunc_XpredictX__58__Vfuncout);
                field_val = __Vfunc_XpredictX__58__Vfuncout;
            }
            this->__PVT__m_written = 1U;
            VL_NULL_CHECK(unnamedblk278__DOT__cbs, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 746)->__VnoInFunc_first(vlProcess, vlSymsp, __Vtask_first__59__Vfuncout);
            ...
            while ((VlNull{} != unnamedblk278__DOT__unnamedblk279__DOT__cb)) {
                ...
                VL_NULL_CHECK(unnamedblk278__DOT__unnamedblk279__DOT__cb, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 747)->__VnoInFunc_post_predict(vlSymsp, 
                                                                                VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field>{this}, this->__PVT__m_mirrored, __Vtask_post_predict__60__value, 2U, VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 748)
                                                                                ->__PVT__path, VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 748)
                                                                                ->__PVT__map);
                field_val = __Vtask_post_predict__60__value;
                VL_NULL_CHECK(unnamedblk278__DOT__cbs, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 746)->__VnoInFunc_next(vlProcess, vlSymsp, __Vtask_next__61__Vfuncout);
                unnamedblk278__DOT__unnamedblk279__DOT__cb 
            ...
            unnamedblk280__DOT__cbs = VL_NEW(uvmt_fifo_tb_uvm_pkg__03a__03auvm_callback_iter__pi189, vlSymsp, 
                                             VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field>{this});
            if (((0U == VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 758)
                  ->__PVT__path) || (2U == VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 758)
                                     ->__PVT__path))) {
                this->__VnoInFunc_get_access(vlProcess, vlSymsp, VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 760)
            ...
            VL_NULL_CHECK(unnamedblk280__DOT__cbs, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 784)->__VnoInFunc_first(vlProcess, vlSymsp, __Vtask_first__64__Vfuncout);
            ...
            while ((VlNull{} != unnamedblk280__DOT__unnamedblk282__DOT__cb)) {
                ...
                VL_NULL_CHECK(unnamedblk280__DOT__unnamedblk282__DOT__cb, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 785)->__VnoInFunc_post_predict(vlSymsp, 
                                                                                VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field>{this}, this->__PVT__m_mirrored, __Vtask_post_predict__65__value, 1U, VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 786)
                                                                                ->__PVT__path, VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 786)
                                                                                ->__PVT__map);
                field_val = __Vtask_post_predict__65__value;
                VL_NULL_CHECK(unnamedblk280__DOT__cbs, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 784)->__VnoInFunc_next(vlProcess, vlSymsp, __Vtask_next__66__Vfuncout);
                unnamedblk280__DOT__unnamedblk282__DOT__cb 
            ...
            if (([&]() {
                        VL_NULL_CHECK(this->__PVT__m_parent, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 794)
                ...
                if ((0U != ([&]() {
                    ...
                    __Vtask_uvm_report_warning__72__filename = "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh"s;
                    ...
                    __Vtask_uvm_report_warning__72__message 
                        = VL_CVT_PACK_STR_NN(VL_CONCATN_NNN(
                                                ...
                                                this->__VnoInFunc_get_name(vlSymsp, __Vfunc_get_name__73__Vfuncout);
                                                                           ...
                                                                           ([&]() {
                                        VL_NULL_CHECK(this->__PVT__m_parent, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 797)
                    ...
                    VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_warning__Vstatic__cs, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_globals.svh", 155)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__76__Vfuncout);
                    vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_warning__Vstatic__top 
                        = __Vtask_get_root__76__Vfuncout;
                    VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_warning__Vstatic__top, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_globals.svh", 156)->__VnoInFunc_uvm_report_warning(vlProcess, vlSymsp, __Vtask_uvm_report_warning__72__id, __Vtask_uvm_report_warning__72__message, __Vtask_uvm_report_warning__72__verbosity, __Vtask_uvm_report_warning__72__filename, __Vtask_uvm_report_warning__72__line, __Vtask_uvm_report_warning__72__context_name, (IData)(__Vtask_uvm_report_warning__72__report_enabled_checked));
                }
                VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 798)->__PVT__status = 1U;
            }
        }
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_XupdateX(uvmt_fifo_tb__Syms* __restrict vlSymsp, QData/*63:0*/ &XupdateX__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_XupdateX\n"); );
    // Body
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_set(VlProcessRef vlProcess, uvmt_fifo_tb__Syms* __restrict vlSymsp, QData/*63:0*/ value, std::string fname, IData/*31:0*/ lineno) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_set\n"); );
    // Locals
    ...
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__79__Vfuncout;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_root> __Vtask_get_root__80__Vfuncout;
    ...
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__89__Vfuncout;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_root> __Vtask_get_root__90__Vfuncout;
    ...
    if ((0U != VL_SHIFTR_QQI(64,64,32, value, this->__PVT__m_size))) {
        if ((0U != ([&]() {
            ...
            __Vtask_uvm_report_warning__82__filename = "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh"s;
            ...
            VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_warning__Vstatic__cs, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_globals.svh", 155)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__85__Vfuncout);
            vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_warning__Vstatic__top 
                = __Vtask_get_root__85__Vfuncout;
            VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_warning__Vstatic__top, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_globals.svh", 156)->__VnoInFunc_uvm_report_warning(vlProcess, vlSymsp, __Vtask_uvm_report_warning__82__id, __Vtask_uvm_report_warning__82__message, __Vtask_uvm_report_warning__82__verbosity, __Vtask_uvm_report_warning__82__filename, __Vtask_uvm_report_warning__82__line, __Vtask_uvm_report_warning__82__context_name, (IData)(__Vtask_uvm_report_warning__82__report_enabled_checked));
        }
        value = (value & mask);
    }
    if (([&]() {
                VL_NULL_CHECK(this->__PVT__m_parent, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 867)
        ...
        if ((0U != ([&]() {
            ...
            __Vtask_uvm_report_warning__92__filename = "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh"s;
            ...
            __Vtemp_3 = ([&]() {
                    VL_NULL_CHECK(this->__PVT__m_parent, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 870)
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_get(uvmt_fifo_tb__Syms* __restrict vlSymsp, std::string fname, IData/*31:0*/ lineno, QData/*63:0*/ &get__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_get\n"); );
    // Body
    this->__PVT__m_fname = fname;
    this->__PVT__m_lineno = lineno;
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_get_mirrored_value(uvmt_fifo_tb__Syms* __restrict vlSymsp, std::string fname, IData/*31:0*/ lineno, QData/*63:0*/ &get_mirrored_value__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_get_mirrored_value\n"); );
    // Body
    this->__PVT__m_fname = fname;
    this->__PVT__m_lineno = lineno;
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_reset(uvmt_fifo_tb__Syms* __restrict vlSymsp, std::string kind) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_reset\n"); );
    // Body
    {
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_has_reset(uvmt_fifo_tb__Syms* __restrict vlSymsp, std::string kind, CData/*0:0*/ __SYM__delete, CData/*0:0*/ &has_reset__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_has_reset\n"); );
    // Body
    {
        if ((! this->__PVT__m_reset.exists(kind))) {
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_get_reset(uvmt_fifo_tb__Syms* __restrict vlSymsp, std::string kind, QData/*63:0*/ &get_reset__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_get_reset\n"); );
    // Body
    {
        if ((! this->__PVT__m_reset.exists(kind))) {
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_set_reset(uvmt_fifo_tb__Syms* __restrict vlSymsp, QData/*63:0*/ value, std::string kind) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_set_reset\n"); );
    // Body
    this->__PVT__m_reset.at(kind) = (value & (VL_SHIFTL_QQI(64,64,32, 1ULL, this->__PVT__m_size) 
                                              - 1ULL));
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_needs_update(uvmt_fifo_tb__Syms* __restrict vlSymsp, CData/*0:0*/ &needs_update__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_needs_update\n"); );
    // Body
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_Xcheck_accessX(uvmt_fifo_tb__Syms* __restrict vlSymsp, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_item> rw, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_map_info> &map_info, CData/*0:0*/ &Xcheck_accessX__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_Xcheck_accessX\n"); );
    // Locals
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_block> __Vtask_get_block__98__Vfuncout;
    IData/*31:0*/ __Vtask_get_default_door__99__Vfuncout;
    __Vtask_get_default_door__99__Vfuncout = 0;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_backdoor> __Vtask_get_backdoor__100__Vfuncout;
    ...
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__103__Vfuncout;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_root> __Vtask_get_root__104__Vfuncout;
    ...
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__108__Vfuncout;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_root> __Vtask_get_root__109__Vfuncout;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_map> __Vfunc_backdoor__111__Vfuncout;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_map> __Vtask_get_local_map__112__Vfuncout;
    ...
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__115__Vfuncout;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_root> __Vtask_get_root__116__Vfuncout;
    ...
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__121__Vfuncout;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_root> __Vtask_get_root__122__Vfuncout;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_map_info> __Vtask_get_reg_map_info__124__Vfuncout;
    ...
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__132__Vfuncout;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_root> __Vtask_get_root__133__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_block> unnamedblk283__DOT__blk;
    {
        if ((3U == VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 992)
             ->__PVT__path)) {
            VL_NULL_CHECK(this->__PVT__m_parent, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 993)->__VnoInFunc_get_block(vlSymsp, __Vtask_get_block__98__Vfuncout);
            unnamedblk283__DOT__blk = __Vtask_get_block__98__Vfuncout;
            VL_NULL_CHECK(unnamedblk283__DOT__blk, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 994)->__VnoInFunc_get_default_door(vlSymsp, __Vtask_get_default_door__99__Vfuncout);
            VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 994)->__PVT__path 
                = __Vtask_get_default_door__99__Vfuncout;
        }
        if ((1U == VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 997)
             ->__PVT__path)) {
            if (((VlNull{} == ([&]() {
                                VL_NULL_CHECK(this->__PVT__m_parent, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 998)
                ...
                if ((0U != ([&]() {
                    ...
                    __Vtask_uvm_report_warning__106__filename = "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh"s;
                    ...
                    VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_warning__Vstatic__cs, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_globals.svh", 155)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__109__Vfuncout);
                    vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_warning__Vstatic__top 
                        = __Vtask_get_root__109__Vfuncout;
                    VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_warning__Vstatic__top, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_globals.svh", 156)->__VnoInFunc_uvm_report_warning(vlProcess, vlSymsp, __Vtask_uvm_report_warning__106__id, __Vtask_uvm_report_warning__106__message, __Vtask_uvm_report_warning__106__verbosity, __Vtask_uvm_report_warning__106__filename, __Vtask_uvm_report_warning__106__line, __Vtask_uvm_report_warning__106__context_name, (IData)(__Vtask_uvm_report_warning__106__report_enabled_checked));
                }
                VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1002)->__PVT__path = 0U;
            } else {
                vlSymsp->TOP__uvm_pkg__03a__03auvm_reg_map__Vclpkg.__VnoInFunc_backdoor(vlProcess, vlSymsp, __Vfunc_backdoor__111__Vfuncout);
                VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1005)->__PVT__map 
                    = __Vfunc_backdoor__111__Vfuncout;
            }
        }
        if ((1U != VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1008)
             ->__PVT__path)) {
            VL_NULL_CHECK(this->__PVT__m_parent, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1010)->__VnoInFunc_get_local_map(vlProcess, vlSymsp, VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1010)
                                                                                ->__PVT__map, __Vtask_get_local_map__112__Vfuncout);
            VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1010)->__PVT__local_map 
                = __Vtask_get_local_map__112__Vfuncout;
            if ((VlNull{} == VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1012)
                 ->__PVT__local_map)) {
                if ((0U != ([&]() {
                    ...
                    __Vtask_uvm_report_error__118__filename = "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh"s;
                    ...
                    __Vtask_uvm_report_error__118__message 
                        = VL_CVT_PACK_STR_NN(VL_CONCATN_NNN(
                                                            VL_CONCATN_NNN("No transactor available to physically access memory from map '"s, 
                                                                           ([&]() {
                                        VL_NULL_CHECK(VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1015)
                                                      ->__PVT__map, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1015)
                    ...
                    VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_error__Vstatic__cs, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_globals.svh", 174)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__122__Vfuncout);
                    vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_error__Vstatic__top 
                ...
                VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1016)->__PVT__status = 1U;
                Xcheck_accessX__Vfuncrtn = 0U;
                goto __Vlabel0;
            }
            VL_NULL_CHECK(VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1020)
                          ->__PVT__local_map, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1020)->__VnoInFunc_get_reg_map_info(vlProcess, vlSymsp, this->__PVT__m_parent, 1U, __Vtask_get_reg_map_info__124__Vfuncout);
            map_info = __Vtask_get_reg_map_info__124__Vfuncout;
            if (((VlNull{} == VL_NULL_CHECK(map_info, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1022)
                  ->__PVT__frontdoor) && VL_NULL_CHECK(map_info, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1022)
                 ->__PVT__unmapped)) {
                if ((0U != ([&]() {
                    ...
                    __Vtask_uvm_report_error__129__filename = "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh"s;
                    ...
                    __Vtask_uvm_report_error__129__message 
                        = VL_CVT_PACK_STR_NN(VL_CONCATN_NNN(
                                                ...
                                                this->__VnoInFunc_get_full_name(vlProcess, vlSymsp, __Vfunc_get_full_name__130__Vfuncout);
                                                                           ...
                                                                           ([&]() {
                                        VL_NULL_CHECK(VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1026)
                                                      ->__PVT__map, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1026)
                    ...
                    VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_error__Vstatic__cs, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_globals.svh", 174)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__133__Vfuncout);
                    vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_error__Vstatic__top 
                ...
                VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1027)->__PVT__status = 1U;
                Xcheck_accessX__Vfuncrtn = 0U;
                goto __Vlabel0;
            }
            if ((VlNull{} == VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1031)
                 ->__PVT__map)) {
                VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1032)->__PVT__map 
                    = VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1032)
                    ->__PVT__local_map;
            }
        }
...
VlCoroutine uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_write(uvmt_fifo_tb__Syms* __restrict vlSymsp, IData/*31:0*/ &status, QData/*63:0*/ value, IData/*31:0*/ path, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_map> map, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_sequence_base> parent, IData/*31:0*/ prior, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_write\n"); );
    // Locals
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_item> __Vfunc_create__135__Vfuncout;
    std::string __Vfunc_get_full_name__136__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VL_KEEP_THIS;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_item> rw;
    vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__pi205__Vclpkg.__VnoInFunc_create(vlProcess, vlSymsp, "field_write_item"s, VlNull{}, 
                                                                                VL_CVT_PACK_STR_NN(
                                                                                ([&]() {
    ...
    VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1053)->__PVT__element 
        = VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field>{this};
    VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1054)->__PVT__element_kind = 1U;
    VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1055)->__PVT__kind = 1U;
    VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1056)->__PVT__value.atWrite(0U) 
        = value;
    VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1057)->__PVT__path 
        = path;
    VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1058)->__PVT__map 
        = map;
    VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1059)->__PVT__parent 
        = parent;
    VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1060)->__PVT__prior 
        = prior;
    VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1061)->__PVT__extension 
        = extension;
    VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1062)->__PVT__fname 
        = fname;
    VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1063)->__PVT__lineno 
        = lineno;
    co_await this->__VnoInFunc_do_write(vlSymsp, rw);
    status = VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1067)
        ->__PVT__status;
    co_return;}

VlCoroutine uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_do_write(uvmt_fifo_tb__Syms* __restrict vlSymsp, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_item> rw) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_do_write\n"); );
    // Locals
    CData/*0:0*/ __Vfunc_Xcheck_accessX__139__Vfuncout;
    __Vfunc_Xcheck_accessX__139__Vfuncout = 0;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_map_info> __Vfunc_Xcheck_accessX__139__map_info;
    ...
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__141__Vfuncout;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_root> __Vtask_get_root__142__Vfuncout;
    ...
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__146__Vfuncout;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_root> __Vtask_get_root__147__Vfuncout;
    ...
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_map> __Vtask_get_root_map__155__Vfuncout;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_cbs> __Vtask_first__159__Vfuncout;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_cbs> __Vtask_next__161__Vfuncout;
    CData/*0:0*/ __Vtask_get_auto_predict__165__Vfuncout;
    __Vtask_get_auto_predict__165__Vfuncout = 0;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_cbs> __Vtask_first__168__Vfuncout;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_cbs> __Vtask_next__170__Vfuncout;
    ...
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__174__Vfuncout;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_root> __Vtask_get_root__175__Vfuncout;
    ...
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_map> unnamedblk285__DOT__system_map;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_callback_iter__pi189> unnamedblk285__DOT__cbs;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_cbs> unnamedblk285__DOT__unnamedblk286__DOT__cb;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_cbs> unnamedblk285__DOT__unnamedblk287__DOT__cb;
    std::string __VCase_hd40f3be7__0;
    QData/*63:0*/ value_adjust;
    value_adjust = 0;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_map_info> map_info;
    VlQueue<VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field>> fields;
    CData/*0:0*/ bad_side_effect;
    bad_side_effect = 0;
    {
        co_await VL_NULL_CHECK(this->__PVT__m_parent, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1081)->__VnoInFunc_XatomicX(vlProcess, vlSymsp, 1U);
        this->__PVT__m_fname = VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1082)
            ->__PVT__fname;
        this->__PVT__m_lineno = VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1083)
            ->__PVT__lineno;
        if ((1U & (~ ([&]() {
        ...
        if ((0U != VL_SHIFTR_QQI(64,64,32, VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1090)
            ...
            if ((0U != ([&]() {
                ...
                __Vtask_uvm_report_warning__144__filename = "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh"s;
                ...
                VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_warning__Vstatic__cs, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_globals.svh", 155)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__147__Vfuncout);
                vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_warning__Vstatic__top 
                    = __Vtask_get_root__147__Vfuncout;
                VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_warning__Vstatic__top, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_globals.svh", 156)->__VnoInFunc_uvm_report_warning(vlProcess, vlSymsp, __Vtask_uvm_report_warning__144__id, __Vtask_uvm_report_warning__144__message, __Vtask_uvm_report_warning__144__verbosity, __Vtask_uvm_report_warning__144__filename, __Vtask_uvm_report_warning__144__line, __Vtask_uvm_report_warning__144__context_name, (IData)(__Vtask_uvm_report_warning__144__report_enabled_checked));
            }
            VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1093)->__PVT__value.atWrite(0U) 
                = (VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1093)
                   ->__PVT__value.at(0U) & (VL_SHIFTL_QQI(64,64,32, 1ULL, this->__PVT__m_size) 
                                            - 1ULL));
        }
        VL_NULL_CHECK(this->__PVT__m_parent, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1097)->__VnoInFunc_get_fields(vlSymsp, fields);
        ...
        while (VL_LTS_III(32, unnamedblk284__DOT__i, fields.size())) {
            {
                if ((fields.at(unnamedblk284__DOT__i) 
                    ...
                    value_adjust = (value_adjust | 
                                    VL_SHIFTL_QQI(64,64,32, VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1101)
                                                  ->__PVT__value.at(0U), this->__PVT__m_lsb));
                    goto __Vlabel1;
                }
                if (([&]() {
                            VL_NULL_CHECK(fields.at(unnamedblk284__DOT__i), "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1106)
                     ->__VnoInFunc_get_access(vlProcess, vlSymsp, VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1106)
                                              ->__PVT__local_map, __Vtask_get_access__150__Vfuncout);
                            __VCase_hd40f3be7__0 = __Vtask_get_access__150__Vfuncout;
                        }(), 1U)) {
                    if ((1U & (~ (((((((("RO"s == __VCase_hd40f3be7__0) 
                                        || ("RC"s == __VCase_hd40f3be7__0)) 
                                       || ("RS"s == __VCase_hd40f3be7__0)) 
                                      || ("W1C"s == __VCase_hd40f3be7__0)) 
                                     || ("W1S"s == __VCase_hd40f3be7__0)) 
                                    || ("W1T"s == __VCase_hd40f3be7__0)) 
                                   || ("W1SRC"s == __VCase_hd40f3be7__0)) 
                                  || ("W1CRC"s == __VCase_hd40f3be7__0))))) {
                        if (((((("W0C"s == __VCase_hd40f3be7__0) 
                                || ("W0S"s == __VCase_hd40f3be7__0)) 
                               || ("W0T"s == __VCase_hd40f3be7__0)) 
                              || ("W0SRC"s == __VCase_hd40f3be7__0)) 
                             || ("W0CRS"s == __VCase_hd40f3be7__0))) {
                            value_adjust = (value_adjust 
                                            | VL_SHIFTL_QQI(64,64,32, 
                                                            (VL_SHIFTL_QQI(64,64,32, 1ULL, 
                                                                           ([&]() {
                                                    VL_NULL_CHECK(fields.at(unnamedblk284__DOT__i), "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1115)
                        ...
                        } else if ((((((("WC"s == __VCase_hd40f3be7__0) 
                                        || ("WS"s == __VCase_hd40f3be7__0)) 
                                       || ("WCRS"s 
                                           == __VCase_hd40f3be7__0)) 
                                      || ("WSRC"s == __VCase_hd40f3be7__0)) 
                                     || ("WOC"s == __VCase_hd40f3be7__0)) 
                                    || ("WOS"s == __VCase_hd40f3be7__0))) {
                            bad_side_effect = 1U;
                        } else {
                            value_adjust = (value_adjust 
                                            | VL_SHIFTL_QQI(64,64,32, VL_NULL_CHECK(fields.at(unnamedblk284__DOT__i), "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1122)
                                                            ->__PVT__m_mirrored, 
                                                            ([&]() {
                                            VL_NULL_CHECK(fields.at(unnamedblk284__DOT__i), "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1122)
        ...
        if (([&]() {
                    this->__VnoInFunc_is_indv_accessible(vlSymsp, VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1134)
                                                         ->__PVT__path, VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1134)
                                                         ->__PVT__local_map, __Vfunc_is_indv_accessible__154__Vfuncout);
                }(), (IData)(__Vfunc_is_indv_accessible__154__Vfuncout))) {
            VL_NULL_CHECK(VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1146)
                          ->__PVT__local_map, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1146)->__VnoInFunc_get_root_map(vlSymsp, __Vtask_get_root_map__155__Vfuncout);
            unnamedblk285__DOT__system_map = __Vtask_get_root_map__155__Vfuncout;
            unnamedblk285__DOT__cbs = VL_NEW(uvmt_fifo_tb_uvm_pkg__03a__03auvm_callback_iter__pi189, vlSymsp, 
                                             VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field>{this});
            VL_NULL_CHECK(this->__PVT__m_parent, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1149)->__VnoInFunc_Xset_busyX(vlSymsp, 1U);
            VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1151)->__PVT__status = 0U;
            this->__VnoInFunc_pre_write(vlSymsp, rw);
            VL_NULL_CHECK(unnamedblk285__DOT__cbs, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1154)->__VnoInFunc_first(vlProcess, vlSymsp, __Vtask_first__159__Vfuncout);
            ...
            while ((VlNull{} != unnamedblk285__DOT__unnamedblk286__DOT__cb)) {
                VL_NULL_CHECK(unnamedblk285__DOT__unnamedblk286__DOT__cb, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1155)->__VnoInFunc_pre_write(vlProcess, vlSymsp, rw);
                VL_NULL_CHECK(unnamedblk285__DOT__cbs, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1154)->__VnoInFunc_next(vlProcess, vlSymsp, __Vtask_next__161__Vfuncout);
                unnamedblk285__DOT__unnamedblk286__DOT__cb 
                    = __Vtask_next__161__Vfuncout;
            }
            if ((0U != VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1157)
                 ->__PVT__status)) {
                this->__PVT__m_write_in_progress = 0U;
                VL_NULL_CHECK(this->__PVT__m_parent, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1159)->__VnoInFunc_Xset_busyX(vlSymsp, 0U);
                co_await VL_NULL_CHECK(this->__PVT__m_parent, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1160)->__VnoInFunc_XatomicX(vlProcess, vlSymsp, 0U);
                goto __Vlabel0;
            }
            co_await VL_NULL_CHECK(VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1165)
                                   ->__PVT__local_map, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1165)->__VnoInFunc_do_write(vlProcess, vlSymsp, rw);
            if (([&]() {
                        VL_NULL_CHECK(unnamedblk285__DOT__system_map, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1167)
            ...
            VL_NULL_CHECK(unnamedblk285__DOT__cbs, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1172)->__VnoInFunc_first(vlProcess, vlSymsp, __Vtask_first__168__Vfuncout);
            ...
            while ((VlNull{} != unnamedblk285__DOT__unnamedblk287__DOT__cb)) {
                VL_NULL_CHECK(unnamedblk285__DOT__unnamedblk287__DOT__cb, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1173)->__VnoInFunc_post_write(vlSymsp, rw);
                VL_NULL_CHECK(unnamedblk285__DOT__cbs, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1172)->__VnoInFunc_next(vlProcess, vlSymsp, __Vtask_next__170__Vfuncout);
                unnamedblk285__DOT__unnamedblk287__DOT__cb 
                    = __Vtask_next__170__Vfuncout;
            }
            VL_NULL_CHECK(this->__PVT__m_parent, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1175)->__VnoInFunc_Xset_busyX(vlSymsp, 0U);
        } else {
            VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1135)->__PVT__element_kind = 0U;
            VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1136)->__PVT__element 
                = this->__PVT__m_parent;
            VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1137)->__PVT__value.atWrite(0U) 
                = value_adjust;
            co_await VL_NULL_CHECK(this->__PVT__m_parent, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1138)->__VnoInFunc_do_write(vlProcess, vlSymsp, rw);
            if (bad_side_effect) {
                if ((0U != ([&]() {
                    ...
                    __Vtask_uvm_report_warning__177__filename = "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh"s;
                    ...
                    VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_warning__Vstatic__cs, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_globals.svh", 155)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__180__Vfuncout);
                    vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_warning__Vstatic__top 
                        = __Vtask_get_root__180__Vfuncout;
                    VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_warning__Vstatic__top, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_globals.svh", 156)->__VnoInFunc_uvm_report_warning(vlProcess, vlSymsp, __Vtask_uvm_report_warning__177__id, __Vtask_uvm_report_warning__177__message, __Vtask_uvm_report_warning__177__verbosity, __Vtask_uvm_report_warning__177__filename, __Vtask_uvm_report_warning__177__line, __Vtask_uvm_report_warning__177__context_name, (IData)(__Vtask_uvm_report_warning__177__report_enabled_checked));
                }
            }
        }
        this->__PVT__m_write_in_progress = 0U;
        co_await VL_NULL_CHECK(this->__PVT__m_parent, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1182)->__VnoInFunc_XatomicX(vlProcess, vlSymsp, 0U);
        __Vlabel0: ;
    }
    co_return;}

VlCoroutine uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_read(uvmt_fifo_tb__Syms* __restrict vlSymsp, IData/*31:0*/ &status, QData/*63:0*/ &value, IData/*31:0*/ path, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_map> map, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_sequence_base> parent, IData/*31:0*/ prior, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_read\n"); );
    // Locals
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_item> __Vfunc_create__183__Vfuncout;
    std::string __Vfunc_get_full_name__184__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VL_KEEP_THIS;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_item> rw;
    vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__pi205__Vclpkg.__VnoInFunc_create(vlProcess, vlSymsp, "field_read_item"s, VlNull{}, 
                                                                                VL_CVT_PACK_STR_NN(
                                                                                ([&]() {
    ...
    VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1201)->__PVT__element 
        = VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field>{this};
    VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1202)->__PVT__element_kind = 1U;
    VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1203)->__PVT__kind = 0U;
    VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1204)->__PVT__value.atWrite(0U) = 0ULL;
    VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1205)->__PVT__path 
        = path;
    VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1206)->__PVT__map 
        = map;
    VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1207)->__PVT__parent 
        = parent;
    VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1208)->__PVT__prior 
        = prior;
    VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1209)->__PVT__extension 
        = extension;
    VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1210)->__PVT__fname 
        = fname;
    VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1211)->__PVT__lineno 
        = lineno;
    co_await this->__VnoInFunc_do_read(vlSymsp, rw);
    value = VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1215)
        ->__PVT__value.at(0U);
    status = VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1216)
        ->__PVT__status;
    co_return;}

VlCoroutine uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_do_read(uvmt_fifo_tb__Syms* __restrict vlSymsp, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_item> rw) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_do_read\n"); );
    // Locals
    CData/*0:0*/ __Vfunc_Xcheck_accessX__187__Vfuncout;
    __Vfunc_Xcheck_accessX__187__Vfuncout = 0;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_map_info> __Vfunc_Xcheck_accessX__187__map_info;
    CData/*0:0*/ __Vfunc_is_indv_accessible__188__Vfuncout;
    __Vfunc_is_indv_accessible__188__Vfuncout = 0;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_map> __Vtask_get_root_map__189__Vfuncout;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_cbs> __Vtask_first__193__Vfuncout;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_cbs> __Vtask_next__195__Vfuncout;
    CData/*0:0*/ __Vtask_get_auto_predict__199__Vfuncout;
    __Vtask_get_auto_predict__199__Vfuncout = 0;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_cbs> __Vtask_first__202__Vfuncout;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_cbs> __Vtask_next__204__Vfuncout;
    ...
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__211__Vfuncout;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_root> __Vtask_get_root__212__Vfuncout;
    ...
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__216__Vfuncout;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_root> __Vtask_get_root__217__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VL_KEEP_THIS;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_map> unnamedblk288__DOT__system_map;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_callback_iter__pi189> unnamedblk288__DOT__cbs;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_cbs> unnamedblk288__DOT__unnamedblk289__DOT__cb;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_cbs> unnamedblk288__DOT__unnamedblk290__DOT__cb;
    VlQueue<VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field>> unnamedblk291__DOT__fields;
    ...
    bad_side_effect = 0;
    {
        co_await VL_NULL_CHECK(this->__PVT__m_parent, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1228)->__VnoInFunc_XatomicX(vlProcess, vlSymsp, 1U);
        this->__PVT__m_fname = VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1229)
            ->__PVT__fname;
        this->__PVT__m_lineno = VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1230)
            ->__PVT__lineno;
        ...
        if (([&]() {
                    this->__VnoInFunc_is_indv_accessible(vlSymsp, VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1244)
                                                         ->__PVT__path, VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1244)
                                                         ->__PVT__local_map, __Vfunc_is_indv_accessible__188__Vfuncout);
                }(), (IData)(__Vfunc_is_indv_accessible__188__Vfuncout))) {
            VL_NULL_CHECK(VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1253)
                          ->__PVT__local_map, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1253)->__VnoInFunc_get_root_map(vlSymsp, __Vtask_get_root_map__189__Vfuncout);
            unnamedblk288__DOT__system_map = __Vtask_get_root_map__189__Vfuncout;
            unnamedblk288__DOT__cbs = VL_NEW(uvmt_fifo_tb_uvm_pkg__03a__03auvm_callback_iter__pi189, vlSymsp, 
                                             VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field>{this});
            VL_NULL_CHECK(this->__PVT__m_parent, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1256)->__VnoInFunc_Xset_busyX(vlSymsp, 1U);
            VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1258)->__PVT__status = 0U;
            this->__VnoInFunc_pre_read(vlSymsp, rw);
            VL_NULL_CHECK(unnamedblk288__DOT__cbs, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1261)->__VnoInFunc_first(vlProcess, vlSymsp, __Vtask_first__193__Vfuncout);
            ...
            while ((VlNull{} != unnamedblk288__DOT__unnamedblk289__DOT__cb)) {
                VL_NULL_CHECK(unnamedblk288__DOT__unnamedblk289__DOT__cb, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1262)->__VnoInFunc_pre_read(vlProcess, vlSymsp, rw);
                VL_NULL_CHECK(unnamedblk288__DOT__cbs, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1261)->__VnoInFunc_next(vlProcess, vlSymsp, __Vtask_next__195__Vfuncout);
                unnamedblk288__DOT__unnamedblk289__DOT__cb 
                    = __Vtask_next__195__Vfuncout;
            }
            if ((0U != VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1264)
                 ->__PVT__status)) {
                this->__PVT__m_read_in_progress = 0U;
                VL_NULL_CHECK(this->__PVT__m_parent, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1266)->__VnoInFunc_Xset_busyX(vlSymsp, 0U);
                co_await VL_NULL_CHECK(this->__PVT__m_parent, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1267)->__VnoInFunc_XatomicX(vlProcess, vlSymsp, 0U);
                goto __Vlabel0;
            }
            co_await VL_NULL_CHECK(VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1272)
                                   ->__PVT__local_map, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1272)->__VnoInFunc_do_read(vlProcess, vlSymsp, rw);
            if (([&]() {
                        VL_NULL_CHECK(unnamedblk288__DOT__system_map, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1275)
            ...
            VL_NULL_CHECK(unnamedblk288__DOT__cbs, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1280)->__VnoInFunc_first(vlProcess, vlSymsp, __Vtask_first__202__Vfuncout);
            ...
            while ((VlNull{} != unnamedblk288__DOT__unnamedblk290__DOT__cb)) {
                VL_NULL_CHECK(unnamedblk288__DOT__unnamedblk290__DOT__cb, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1281)->__VnoInFunc_post_read(vlSymsp, rw);
                VL_NULL_CHECK(unnamedblk288__DOT__cbs, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1280)->__VnoInFunc_next(vlProcess, vlSymsp, __Vtask_next__204__Vfuncout);
                unnamedblk288__DOT__unnamedblk290__DOT__cb 
                    = __Vtask_next__204__Vfuncout;
            }
            VL_NULL_CHECK(this->__PVT__m_parent, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1283)->__VnoInFunc_Xset_busyX(vlSymsp, 0U);
        } else {
            VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1245)->__PVT__element_kind = 0U;
            VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1246)->__PVT__element 
                = this->__PVT__m_parent;
            bad_side_effect = 1U;
            co_await VL_NULL_CHECK(this->__PVT__m_parent, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1248)->__VnoInFunc_do_read(vlProcess, vlSymsp, rw);
            VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1249)->__PVT__value.atWrite(0U) 
                = (VL_SHIFTR_QQI(64,64,32, VL_NULL_CHECK(rw, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1249)
                                 ->__PVT__value.at(0U), this->__PVT__m_lsb) 
                   & (VL_SHIFTL_QQI(64,64,32, 1ULL, this->__PVT__m_size) 
                      - 1ULL));
        }
        this->__PVT__m_read_in_progress = 0U;
        co_await VL_NULL_CHECK(this->__PVT__m_parent, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1290)->__VnoInFunc_XatomicX(vlProcess, vlSymsp, 0U);
        if (bad_side_effect) {
            VL_NULL_CHECK(this->__PVT__m_parent, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1294)->__VnoInFunc_get_fields(vlSymsp, unnamedblk291__DOT__fields);
            ...
            while (VL_LTS_III(32, unnamedblk291__DOT__unnamedblk292__DOT__i, unnamedblk291__DOT__fields.size())) {
                {
                    ...
                    VL_NULL_CHECK(unnamedblk291__DOT__fields.at(unnamedblk291__DOT__unnamedblk292__DOT__i), "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1299)->__VnoInFunc_get_access(vlProcess, vlSymsp, VlNull{}, __Vtask_get_access__209__Vfuncout);
                    ...
                    if ((((((((((("RC"s == unnamedblk291__DOT__unnamedblk292__DOT__unnamedblk293__DOT__mode) 
                        ...
                        if ((0U != ([&]() {
                            ...
                            __Vtask_uvm_report_warning__214__filename = "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh"s;
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_is_indv_accessible(uvmt_fifo_tb__Syms* __restrict vlSymsp, IData/*31:0*/ path, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_map> local_map, CData/*0:0*/ &is_indv_accessible__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_is_indv_accessible\n"); );
    // Locals
    ...
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__220__Vfuncout;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_root> __Vtask_get_root__221__Vfuncout;
    ...
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__229__Vfuncout;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_root> __Vtask_get_root__230__Vfuncout;
    ...
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__234__Vfuncout;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_root> __Vtask_get_root__235__Vfuncout;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_frontdoor> __Vtask_get_frontdoor__237__Vfuncout;
    ...
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__239__Vfuncout;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_root> __Vtask_get_root__240__Vfuncout;
    ...
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__245__Vfuncout;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_root> __Vtask_get_root__246__Vfuncout;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_map> __Vtask_get_root_map__248__Vfuncout;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_adapter> __Vtask_get_adapter__249__Vfuncout;
    ...
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_map> unnamedblk294__DOT__system_map;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_adapter> unnamedblk294__DOT__adapter;
    ...
    VlQueue<VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field>> unnamedblk295__DOT__fields;
    ...
    unnamedblk295__DOT__unnamedblk296__DOT__unnamedblk297__DOT__i = 0;
    {
        if ((1U == path)) {
            if ((0U != ([&]() {
                ...
                __Vtask_uvm_report_warning__223__filename = "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh"s;
                ...
                VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_warning__Vstatic__cs, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_globals.svh", 155)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__226__Vfuncout);
                vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_warning__Vstatic__top 
                    = __Vtask_get_root__226__Vfuncout;
                VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_warning__Vstatic__top, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_globals.svh", 156)->__VnoInFunc_uvm_report_warning(vlProcess, vlSymsp, __Vtask_uvm_report_warning__223__id, __Vtask_uvm_report_warning__223__message, __Vtask_uvm_report_warning__223__verbosity, __Vtask_uvm_report_warning__223__filename, __Vtask_uvm_report_warning__223__line, __Vtask_uvm_report_warning__223__context_name, (IData)(__Vtask_uvm_report_warning__223__report_enabled_checked));
            }
        ...
        if ((1U & (~ (IData)(this->__PVT__m_individually_accessible)))) {
            if ((0U != ([&]() {
                ...
                __Vtask_uvm_report_warning__232__filename = "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh"s;
                ...
                VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_warning__Vstatic__cs, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_globals.svh", 155)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__235__Vfuncout);
                vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_warning__Vstatic__top 
                    = __Vtask_get_root__235__Vfuncout;
                VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_warning__Vstatic__top, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_globals.svh", 156)->__VnoInFunc_uvm_report_warning(vlProcess, vlSymsp, __Vtask_uvm_report_warning__232__id, __Vtask_uvm_report_warning__232__message, __Vtask_uvm_report_warning__232__verbosity, __Vtask_uvm_report_warning__232__filename, __Vtask_uvm_report_warning__232__line, __Vtask_uvm_report_warning__232__context_name, (IData)(__Vtask_uvm_report_warning__232__report_enabled_checked));
            }
            is_indv_accessible__Vfuncrtn = 0U;
            goto __Vlabel0;
        }
        if ((VlNull{} != ([&]() {
                        VL_NULL_CHECK(this->__PVT__m_parent, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1340)
            ...
            if ((0U != ([&]() {
                ...
                __Vtask_uvm_report_warning__242__filename = "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh"s;
                ...
                __Vtask_uvm_report_warning__242__message 
                    = VL_CVT_PACK_STR_NN(VL_CONCATN_NNN(
                                            ...
                                            this->__VnoInFunc_get_name(vlSymsp, __Vfunc_get_name__243__Vfuncout);
                                                                       ...
                                                                       ([&]() {
                                    VL_NULL_CHECK(this->__PVT__m_parent, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1343)
                ...
                VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_warning__Vstatic__cs, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_globals.svh", 155)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__246__Vfuncout);
                vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_warning__Vstatic__top 
                    = __Vtask_get_root__246__Vfuncout;
                VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_warning__Vstatic__top, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_globals.svh", 156)->__VnoInFunc_uvm_report_warning(vlProcess, vlSymsp, __Vtask_uvm_report_warning__242__id, __Vtask_uvm_report_warning__242__message, __Vtask_uvm_report_warning__242__verbosity, __Vtask_uvm_report_warning__242__filename, __Vtask_uvm_report_warning__242__line, __Vtask_uvm_report_warning__242__context_name, (IData)(__Vtask_uvm_report_warning__242__report_enabled_checked));
            }
            is_indv_accessible__Vfuncrtn = 0U;
            goto __Vlabel0;
        }
        VL_NULL_CHECK(local_map, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1348)->__VnoInFunc_get_root_map(vlSymsp, __Vtask_get_root_map__248__Vfuncout);
        unnamedblk294__DOT__system_map = __Vtask_get_root_map__248__Vfuncout;
        VL_NULL_CHECK(unnamedblk294__DOT__system_map, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1349)->__VnoInFunc_get_adapter(vlSymsp, 1U, __Vtask_get_adapter__249__Vfuncout);
        unnamedblk294__DOT__adapter = __Vtask_get_adapter__249__Vfuncout;
        if (VL_NULL_CHECK(unnamedblk294__DOT__adapter, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1350)
            ->__PVT__supports_byte_enable) {
            is_indv_accessible__Vfuncrtn = 1U;
            goto __Vlabel0;
        }
        VL_NULL_CHECK(local_map, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1356)->__VnoInFunc_get_n_bytes(vlSymsp, 1U, __Vtask_get_n_bytes__250__Vfuncout);
        unnamedblk295__DOT__bus_width = __Vtask_get_n_bytes__250__Vfuncout;
        VL_NULL_CHECK(this->__PVT__m_parent, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1360)->__VnoInFunc_get_fields(vlSymsp, unnamedblk295__DOT__fields);
        if ((1U == unnamedblk295__DOT__fields.size())) {
            ...
            VL_NULL_CHECK(unnamedblk295__DOT__fields.at(unnamedblk295__DOT__fld_idx), "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1377)->__VnoInFunc_get_lsb_pos(vlSymsp, __Vtask_get_lsb_pos__252__Vfuncout);
            unnamedblk295__DOT__unnamedblk296__DOT__this_lsb 
                = __Vtask_get_lsb_pos__252__Vfuncout;
            VL_NULL_CHECK(unnamedblk295__DOT__fields.at(unnamedblk295__DOT__fld_idx), "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1378)->__VnoInFunc_get_n_bits(vlSymsp, __Vtask_get_n_bits__253__Vfuncout);
            ...
            if (VL_LTS_III(32, 0U, unnamedblk295__DOT__fld_idx)) {
                VL_NULL_CHECK(unnamedblk295__DOT__fields.at(
                                                            (unnamedblk295__DOT__fld_idx 
                                                             - (IData)(1U))), "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1381)->__VnoInFunc_get_lsb_pos(vlSymsp, __Vtask_get_lsb_pos__254__Vfuncout);
                unnamedblk295__DOT__unnamedblk296__DOT__prev_lsb 
                    = __Vtask_get_lsb_pos__254__Vfuncout;
                VL_NULL_CHECK(unnamedblk295__DOT__fields.at(
                                                            (unnamedblk295__DOT__fld_idx 
                                                             - (IData)(1U))), "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1382)->__VnoInFunc_get_n_bits(vlSymsp, __Vtask_get_n_bits__255__Vfuncout);
            ...
            if (VL_LTS_III(32, unnamedblk295__DOT__fld_idx, 
                ...
                VL_NULL_CHECK(unnamedblk295__DOT__fields.at(
                                                            ((IData)(1U) 
                                                             + unnamedblk295__DOT__fld_idx)), "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1386)->__VnoInFunc_get_lsb_pos(vlSymsp, __Vtask_get_lsb_pos__256__Vfuncout);
                unnamedblk295__DOT__unnamedblk296__DOT__next_lsb 
                    = __Vtask_get_lsb_pos__256__Vfuncout;
                VL_NULL_CHECK(unnamedblk295__DOT__fields.at(
                                                            ((IData)(1U) 
                                                             + unnamedblk295__DOT__fld_idx)), "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1387)->__VnoInFunc_get_n_bits(vlSymsp, __Vtask_get_n_bits__257__Vfuncout);
        ...
        if ((0U != ([&]() {
            ...
            __Vtask_uvm_report_warning__262__filename = "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh"s;
            ...
            VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_warning__Vstatic__cs, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_globals.svh", 155)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__265__Vfuncout);
            vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_warning__Vstatic__top 
                = __Vtask_get_root__265__Vfuncout;
            VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_warning__Vstatic__top, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_globals.svh", 156)->__VnoInFunc_uvm_report_warning(vlProcess, vlSymsp, __Vtask_uvm_report_warning__262__id, __Vtask_uvm_report_warning__262__message, __Vtask_uvm_report_warning__262__verbosity, __Vtask_uvm_report_warning__262__filename, __Vtask_uvm_report_warning__262__line, __Vtask_uvm_report_warning__262__context_name, (IData)(__Vtask_uvm_report_warning__262__report_enabled_checked));
        }
        is_indv_accessible__Vfuncrtn = 0U;
        __Vlabel0: ;
    }
...
VlCoroutine uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_poke(uvmt_fifo_tb__Syms* __restrict vlSymsp, IData/*31:0*/ &status, QData/*63:0*/ value, std::string kind, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_sequence_base> parent, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_poke\n"); );
    // Locals
    ...
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__268__Vfuncout;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_root> __Vtask_get_root__269__Vfuncout;
    ...
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__273__Vfuncout;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_root> __Vtask_get_root__274__Vfuncout;
    ...
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__279__Vfuncout;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_root> __Vtask_get_root__280__Vfuncout;
    ...
    tmp = 0;
    {
        ...
        if ((0U != VL_SHIFTR_QQI(64,64,32, value, this->__PVT__m_size))) {
            if ((0U != ([&]() {
                ...
                __Vtask_uvm_report_warning__271__filename = "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh"s;
                ...
                VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_warning__Vstatic__cs, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_globals.svh", 155)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__274__Vfuncout);
                vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_warning__Vstatic__top 
                    = __Vtask_get_root__274__Vfuncout;
                VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_warning__Vstatic__top, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_globals.svh", 156)->__VnoInFunc_uvm_report_warning(vlProcess, vlSymsp, __Vtask_uvm_report_warning__271__id, __Vtask_uvm_report_warning__271__message, __Vtask_uvm_report_warning__271__verbosity, __Vtask_uvm_report_warning__271__filename, __Vtask_uvm_report_warning__271__line, __Vtask_uvm_report_warning__271__context_name, (IData)(__Vtask_uvm_report_warning__271__report_enabled_checked));
            }
            value = (value & (VL_SHIFTL_QQI(64,64,32, 1ULL, this->__PVT__m_size) 
                              - 1ULL));
        }
        co_await VL_NULL_CHECK(this->__PVT__m_parent, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1451)->__VnoInFunc_XatomicX(vlProcess, vlSymsp, 1U);
        VL_NULL_CHECK(this->__PVT__m_parent, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1452)->__PVT__m_is_locked_by_field = 1U;
        tmp = 0ULL;
        co_await VL_NULL_CHECK(this->__PVT__m_parent, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1457)->__VnoInFunc_peek(vlSymsp, __Vtask_peek__277__status, __Vtask_peek__277__value, kind, parent, extension, fname, lineno);
        ...
        if ((1U == status)) {
            if ((0U != ([&]() {
                ...
                __Vtask_uvm_report_error__282__filename = "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh"s;
                    ...
                    = VL_CVT_PACK_STR_NN(VL_CONCATN_NNN(
                                                        VL_CONCATN_NNN(
                                                                       VL_CONCATN_NNN("uvm_reg_field::poke(): Peek of register '"s, 
                                                                                ([&]() {
                                        VL_NULL_CHECK(this->__PVT__m_parent, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1461)
                                                        ...
                                                        uvmt_fifo_tb___024unit::__Venumtab_enum_name83
                                                        [
                                                        (3U 
                                                         & status)]));
                ...
                VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_error__Vstatic__cs, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_globals.svh", 174)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__285__Vfuncout);
                vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_error__Vstatic__top 
            ...
            co_await VL_NULL_CHECK(this->__PVT__m_parent, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1462)->__VnoInFunc_XatomicX(vlProcess, vlSymsp, 0U);
            VL_NULL_CHECK(this->__PVT__m_parent, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1463)->__PVT__m_is_locked_by_field = 0U;
            goto __Vlabel0;
        }
        ...
        co_await VL_NULL_CHECK(this->__PVT__m_parent, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1470)->__VnoInFunc_poke(vlSymsp, __Vtask_poke__288__status, tmp, kind, parent, extension, fname, lineno);
        status = __Vtask_poke__288__status;
        co_await VL_NULL_CHECK(this->__PVT__m_parent, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1472)->__VnoInFunc_XatomicX(vlProcess, vlSymsp, 0U);
        VL_NULL_CHECK(this->__PVT__m_parent, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1473)->__PVT__m_is_locked_by_field = 0U;
        __Vlabel0: ;
    }
    co_return;}

VlCoroutine uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_peek(uvmt_fifo_tb__Syms* __restrict vlSymsp, IData/*31:0*/ &status, QData/*63:0*/ &value, std::string kind, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_sequence_base> parent, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_peek\n"); );
    // Locals
    ...
    this->__PVT__m_fname = fname;
    this->__PVT__m_lineno = lineno;
    co_await VL_NULL_CHECK(this->__PVT__m_parent, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1491)->__VnoInFunc_peek(vlSymsp, __Vtask_peek__290__status, __Vtask_peek__290__value, kind, parent, extension, fname, lineno);
...
VlCoroutine uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_mirror(uvmt_fifo_tb__Syms* __restrict vlSymsp, IData/*31:0*/ &status, IData/*31:0*/ check, IData/*31:0*/ path, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_map> map, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_sequence_base> parent, IData/*31:0*/ prior, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno) {
    ...
    this->__PVT__m_fname = fname;
    this->__PVT__m_lineno = lineno;
    co_await VL_NULL_CHECK(this->__PVT__m_parent, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1510)->__VnoInFunc_mirror(vlProcess, vlSymsp, __Vtask_mirror__291__status, check, path, map, parent, prior, extension, fname, lineno);
    status = __Vtask_mirror__291__status;
    co_return;}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_set_compare(uvmt_fifo_tb__Syms* __restrict vlSymsp, IData/*31:0*/ check) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_set_compare\n"); );
    // Body
    this->__PVT__m_check = check;
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_get_compare(uvmt_fifo_tb__Syms* __restrict vlSymsp, IData/*31:0*/ &get_compare__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_get_compare\n"); );
    // Body
    get_compare__Vfuncrtn = this->__PVT__m_check;
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_pre_randomize(uvmt_fifo_tb__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_pre_randomize\n"); );
    // Body
    this->__PVT__value = this->__PVT__m_desired;
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_post_randomize(uvmt_fifo_tb__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_post_randomize\n"); );
    // Body
    this->__PVT__m_desired = this->__PVT__value;
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_do_print(VlProcessRef vlProcess, uvmt_fifo_tb__Syms* __restrict vlSymsp, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_printer> printer) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_do_print\n"); );
    // Locals
    ...
    // Body
    VL_NULL_CHECK(printer, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1548)->__VnoInFunc_print_generic(vlProcess, vlSymsp, 
                                                                                VL_CVT_PACK_STR_NN(
                                                                                ([&]() {
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_convert2string(VlProcessRef vlProcess, uvmt_fifo_tb__Syms* __restrict vlSymsp, std::string &convert2string__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_convert2string\n"); );
    // Locals
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg> __Vfunc_get_register__296__Vfuncout;
    ...
    with_debug_info = 0;
    std::string prefix;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg> reg_;
    ...
    __Vtemp_4 = ([&]() {
            VL_NULL_CHECK(reg_, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh", 1566)
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_clone(VlProcessRef vlProcess, uvmt_fifo_tb__Syms* __restrict vlSymsp, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_object> &clone__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_clone\n"); );
    // Locals
    ...
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__305__Vfuncout;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_root> __Vtask_get_root__306__Vfuncout;
    ...
    if ((0U != ([&]() {
        ...
        vlSymsp->TOP__uvm_pkg.__VnoInFunc_uvm_report_fatal_TOP__uvm_pkg(vlProcess, vlSymsp, "RegModel"s, "RegModel field cannot be cloned"s, 0U, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh"s, 0x00000634U, ""s, 1U);
    }
    clone__Vfuncrtn = VlNull{};
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_do_copy(VlProcessRef vlProcess, uvmt_fifo_tb__Syms* __restrict vlSymsp, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_object> rhs) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_do_copy\n"); );
    // Locals
    ...
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__310__Vfuncout;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_root> __Vtask_get_root__311__Vfuncout;
    ...
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__314__Vfuncout;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_root> __Vtask_get_root__315__Vfuncout;
    // Body
    if ((0U != ([&]() {
        ...
        __Vtask_uvm_report_warning__313__filename = "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh"s;
        ...
        VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_warning__Vstatic__cs, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_globals.svh", 155)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__315__Vfuncout);
        vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_warning__Vstatic__top 
            = __Vtask_get_root__315__Vfuncout;
        VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_warning__Vstatic__top, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_globals.svh", 156)->__VnoInFunc_uvm_report_warning(vlProcess, vlSymsp, __Vtask_uvm_report_warning__313__id, __Vtask_uvm_report_warning__313__message, __Vtask_uvm_report_warning__313__verbosity, __Vtask_uvm_report_warning__313__filename, __Vtask_uvm_report_warning__313__line, __Vtask_uvm_report_warning__313__context_name, (IData)(__Vtask_uvm_report_warning__313__report_enabled_checked));
    }
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_do_compare(VlProcessRef vlProcess, uvmt_fifo_tb__Syms* __restrict vlSymsp, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_object> rhs, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_comparer> comparer, CData/*0:0*/ &do_compare__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_do_compare\n"); );
    // Locals
    ...
    if ((0U != ([&]() {
        ...
        __Vtask_uvm_report_warning__321__filename = "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh"s;
        ...
        VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_warning__Vstatic__cs, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_globals.svh", 155)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__323__Vfuncout);
        vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_warning__Vstatic__top 
            = __Vtask_get_root__323__Vfuncout;
        VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_warning__Vstatic__top, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_globals.svh", 156)->__VnoInFunc_uvm_report_warning(vlProcess, vlSymsp, __Vtask_uvm_report_warning__321__id, __Vtask_uvm_report_warning__321__message, __Vtask_uvm_report_warning__321__verbosity, __Vtask_uvm_report_warning__321__filename, __Vtask_uvm_report_warning__321__line, __Vtask_uvm_report_warning__321__context_name, (IData)(__Vtask_uvm_report_warning__321__report_enabled_checked));
    }
    do_compare__Vfuncrtn = 0U;
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_do_pack(VlProcessRef vlProcess, uvmt_fifo_tb__Syms* __restrict vlSymsp, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer> packer) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_do_pack\n"); );
    // Locals
    ...
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__326__Vfuncout;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_root> __Vtask_get_root__327__Vfuncout;
    ...
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__330__Vfuncout;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_root> __Vtask_get_root__331__Vfuncout;
    // Body
    if ((0U != ([&]() {
        ...
        __Vtask_uvm_report_warning__329__filename = "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh"s;
        ...
        VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_warning__Vstatic__cs, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_globals.svh", 155)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__331__Vfuncout);
        vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_warning__Vstatic__top 
            = __Vtask_get_root__331__Vfuncout;
        VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_warning__Vstatic__top, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_globals.svh", 156)->__VnoInFunc_uvm_report_warning(vlProcess, vlSymsp, __Vtask_uvm_report_warning__329__id, __Vtask_uvm_report_warning__329__message, __Vtask_uvm_report_warning__329__verbosity, __Vtask_uvm_report_warning__329__filename, __Vtask_uvm_report_warning__329__line, __Vtask_uvm_report_warning__329__context_name, (IData)(__Vtask_uvm_report_warning__329__report_enabled_checked));
    }
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_do_unpack(VlProcessRef vlProcess, uvmt_fifo_tb__Syms* __restrict vlSymsp, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_packer> packer) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_do_unpack\n"); );
    // Locals
    ...
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__334__Vfuncout;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_root> __Vtask_get_root__335__Vfuncout;
    ...
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__338__Vfuncout;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_root> __Vtask_get_root__339__Vfuncout;
    // Body
    if ((0U != ([&]() {
        ...
        __Vtask_uvm_report_warning__337__filename = "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/reg/uvm_reg_field.svh"s;
        ...
        VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_warning__Vstatic__cs, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_globals.svh", 155)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__339__Vfuncout);
        vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_warning__Vstatic__top 
            = __Vtask_get_root__339__Vfuncout;
        VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_warning__Vstatic__top, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_globals.svh", 156)->__VnoInFunc_uvm_report_warning(vlProcess, vlSymsp, __Vtask_uvm_report_warning__337__id, __Vtask_uvm_report_warning__337__message, __Vtask_uvm_report_warning__337__verbosity, __Vtask_uvm_report_warning__337__filename, __Vtask_uvm_report_warning__337__line, __Vtask_uvm_report_warning__337__context_name, (IData)(__Vtask_uvm_report_warning__337__report_enabled_checked));
    }
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_randomize(uvmt_fifo_tb__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_randomize\n"); );
    // Locals
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_uvm_reg_field_valid_setup_constraint(uvmt_fifo_tb__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_uvm_reg_field_valid_setup_constraint\n"); );
    // Locals
    std::string __Vtemp_1;
    std::string __Vtemp_2;
    std::string __Vtemp_3;
    std::string __Vtemp_4;
    // Body
    __Vtemp_1 = (uvmt_fifo_tb_uvm_pkg__03a__03auvm_void::__Vrandmode.at(0U)
    ...
    __Vtemp_4 = VL_SFORMATF_N_NX("(__Vbv (bvult %@ %@))",0,
                                 -1,&(__Vtemp_1),-1,
                                 &(__Vtemp_2)) ;
    uvmt_fifo_tb_uvm_pkg__03a__03auvm_void::__PVT__constraint.hard(VL_SFORMATF_N_NX("(__Vbv (=> (__Vbool %@) (__Vbool %@)))",0,
                                                                                -1,
                                                                                &(__Vtemp_3),
                                                                                -1,
                                                                                &(__Vtemp_4)) );
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc___Vsetup_constraints(uvmt_fifo_tb__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc___Vsetup_constraints\n"); );
    // Body
    this->__VnoInFunc_uvm_reg_field_valid_setup_constraint(vlSymsp);
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc___VBasicRand(uvmt_fifo_tb__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc___VBasicRand\n"); );
    // Body
    __VBasicRand__Vfuncrtn = 1U;
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::_ctor_var_reset(uvmt_fifo_tb__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::_ctor_var_reset\n"); );
    // Body
...
uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::~uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field() {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::~\n"); );
}

std::string VL_TO_STRING(const VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_reg_field::to_string_middle\n"); );
    // Body
    std::string out;
