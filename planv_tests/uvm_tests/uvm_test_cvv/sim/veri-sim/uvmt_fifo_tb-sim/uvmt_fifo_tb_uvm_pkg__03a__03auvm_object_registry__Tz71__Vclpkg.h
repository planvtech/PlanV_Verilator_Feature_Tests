...
#ifndef VERILATED_UVMT_FIFO_TB_UVM_PKG__03A__03AUVM_OBJECT_REGISTRY__TZ71__VCLPKG_H_
#define VERILATED_UVMT_FIFO_TB_UVM_PKG__03A__03AUVM_OBJECT_REGISTRY__TZ71__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) uvmt_fifo_tb_uvm_pkg__03a__03auvm_object_registry__Tz71__Vclpkg final {
  public:

    // DESIGN SPECIFIC STATE
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_object_registry__Tz71> __PVT__get__Vstatic__m_inst;
    ...
    // CONSTRUCTORS
    uvmt_fifo_tb_uvm_pkg__03a__03auvm_object_registry__Tz71__Vclpkg();
    ~uvmt_fifo_tb_uvm_pkg__03a__03auvm_object_registry__Tz71__Vclpkg();
    void ctor(uvmt_fifo_tb__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(uvmt_fifo_tb_uvm_pkg__03a__03auvm_object_registry__Tz71__Vclpkg);
    ...
    void __VnoInFunc_get(uvmt_fifo_tb__Syms* __restrict vlSymsp, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_object_registry__Tz71> &get__Vfuncrtn);
...
class uvmt_fifo_tb_uvm_pkg__03a__03auvm_object_registry__Tz71 : public uvmt_fifo_tb_uvm_pkg__03a__03auvm_object_wrapper {
  public:
  ...
  public:
    uvmt_fifo_tb_uvm_pkg__03a__03auvm_object_registry__Tz71(uvmt_fifo_tb__Syms* __restrict vlSymsp);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~uvmt_fifo_tb_uvm_pkg__03a__03auvm_object_registry__Tz71();
};
