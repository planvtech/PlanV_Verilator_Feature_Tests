...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_abstract_component_registry__pi1__Vclpkg::__VnoInFunc_type_name(uvmt_fifo_tb__Syms* __restrict vlSymsp, std::string &type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  uvmt_fifo_tb_uvm_pkg__03a__03auvm_abstract_component_registry__pi1__Vclpkg::__VnoInFunc_type_name\n"); );
    // Locals
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_abstract_component_registry__pi1__Vclpkg::__VnoInFunc_get(uvmt_fifo_tb__Syms* __restrict vlSymsp, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_abstract_component_registry__pi1> &get__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  uvmt_fifo_tb_uvm_pkg__03a__03auvm_abstract_component_registry__pi1__Vclpkg::__VnoInFunc_get\n"); );
    // Body
    if ((VlNull{} == this->__PVT__get__Vstatic__m_inst)) {
        this->__PVT__get__Vstatic__m_inst = VL_NEW(uvmt_fifo_tb_uvm_pkg__03a__03auvm_abstract_component_registry__pi1, vlSymsp);
    }
    get__Vfuncrtn = this->__PVT__get__Vstatic__m_inst;
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_abstract_component_registry__pi1__Vclpkg::__VnoInFunc_create(uvmt_fifo_tb__Syms* __restrict vlSymsp, std::string name, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_component> parent, std::string contxt, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_component> &create__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  uvmt_fifo_tb_uvm_pkg__03a__03auvm_abstract_component_registry__pi1__Vclpkg::__VnoInFunc_create\n"); );
    // Locals
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_component> __Vfunc_create__2__Vfuncout;
    // Body
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_abstract_component_registry__pi1__Vclpkg::__VnoInFunc_set_type_override(uvmt_fifo_tb__Syms* __restrict vlSymsp, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_object_wrapper> override_type, CData/*0:0*/ replace) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  uvmt_fifo_tb_uvm_pkg__03a__03auvm_abstract_component_registry__pi1__Vclpkg::__VnoInFunc_set_type_override\n"); );
    // Body
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_abstract_component_registry__pi1__Vclpkg::__VnoInFunc_set_inst_override(uvmt_fifo_tb__Syms* __restrict vlSymsp, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_object_wrapper> override_type, std::string inst_path, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_component> parent) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  uvmt_fifo_tb_uvm_pkg__03a__03auvm_abstract_component_registry__pi1__Vclpkg::__VnoInFunc_set_inst_override\n"); );
    // Body
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_abstract_component_registry__pi1__Vclpkg::__VnoInFunc_set_type_alias(uvmt_fifo_tb__Syms* __restrict vlSymsp, std::string alias_name, CData/*0:0*/ &set_type_alias__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  uvmt_fifo_tb_uvm_pkg__03a__03auvm_abstract_component_registry__pi1__Vclpkg::__VnoInFunc_set_type_alias\n"); );
    // Body
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_abstract_component_registry__pi1::__VnoInFunc_create_component(VlProcessRef vlProcess, uvmt_fifo_tb__Syms* __restrict vlSymsp, std::string name, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_component> parent, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_component> &create_component__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  uvmt_fifo_tb_uvm_pkg__03a__03auvm_abstract_component_registry__pi1::__VnoInFunc_create_component\n"); );
    // Locals
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_abstract_component_registry__pi1::__VnoInFunc_get_type_name(uvmt_fifo_tb__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  uvmt_fifo_tb_uvm_pkg__03a__03auvm_abstract_component_registry__pi1::__VnoInFunc_get_type_name\n"); );
    // Locals
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_registry_common__pi17> __Vfunc_get__11__Vfuncout;
    std::string __Vtask_get_type_name__12__Vfuncout;
    // Body
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_registry_common__pi17> common;
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_abstract_component_registry__pi1::__VnoInFunc_initialize(VlProcessRef vlProcess, uvmt_fifo_tb__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  uvmt_fifo_tb_uvm_pkg__03a__03auvm_abstract_component_registry__pi1::__VnoInFunc_initialize\n"); );
    // Locals
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_registry_common__pi17> __Vfunc_get__13__Vfuncout;
    // Body
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_registry_common__pi17> common;
...
uvmt_fifo_tb_uvm_pkg__03a__03auvm_abstract_component_registry__pi1::uvmt_fifo_tb_uvm_pkg__03a__03auvm_abstract_component_registry__pi1(uvmt_fifo_tb__Syms* __restrict vlSymsp)
    : uvmt_fifo_tb_uvm_pkg__03a__03auvm_object_wrapper(vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  uvmt_fifo_tb_uvm_pkg__03a__03auvm_abstract_component_registry__pi1::new\n"); );
    // Body
    _ctor_var_reset(vlSymsp);
    ;
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_abstract_component_registry__pi1::_ctor_var_reset(uvmt_fifo_tb__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  uvmt_fifo_tb_uvm_pkg__03a__03auvm_abstract_component_registry__pi1::_ctor_var_reset\n"); );
    // Body
    (void)vlSymsp;  // Prevent unused variable warning
}

uvmt_fifo_tb_uvm_pkg__03a__03auvm_abstract_component_registry__pi1::~uvmt_fifo_tb_uvm_pkg__03a__03auvm_abstract_component_registry__pi1() {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  uvmt_fifo_tb_uvm_pkg__03a__03auvm_abstract_component_registry__pi1::~\n"); );
}

std::string VL_TO_STRING(const VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_abstract_component_registry__pi1>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  uvmt_fifo_tb_uvm_pkg__03a__03auvm_abstract_component_registry__pi1::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string uvmt_fifo_tb_uvm_pkg__03a__03auvm_abstract_component_registry__pi1::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  uvmt_fifo_tb_uvm_pkg__03a__03auvm_abstract_component_registry__pi1::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string uvmt_fifo_tb_uvm_pkg__03a__03auvm_abstract_component_registry__pi1::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  uvmt_fifo_tb_uvm_pkg__03a__03auvm_abstract_component_registry__pi1::to_string_middle\n"); );
    // Body
    std::string out;
