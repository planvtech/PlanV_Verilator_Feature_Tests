...
#ifndef VERILATED_UVMT_FIFO_TB_UVM_PKG__03A__03AUVM_SET_BEFORE_GET_DAP__TZ26__VCLPKG_H_
#define VERILATED_UVMT_FIFO_TB_UVM_PKG__03A__03AUVM_SET_BEFORE_GET_DAP__TZ26__VCLPKG_H_  // guard
...
class uvmt_fifo_tb_uvm_pkg__03a__03auvm_set_get_dap_base__Tz26;


class uvmt_fifo_tb__Syms;

class alignas(VL_CACHE_LINE_BYTES) uvmt_fifo_tb_uvm_pkg__03a__03auvm_set_before_get_dap__Tz26__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    uvmt_fifo_tb_uvm_pkg__03a__03auvm_set_before_get_dap__Tz26__Vclpkg();
    ~uvmt_fifo_tb_uvm_pkg__03a__03auvm_set_before_get_dap__Tz26__Vclpkg();
    void ctor(uvmt_fifo_tb__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(uvmt_fifo_tb_uvm_pkg__03a__03auvm_set_before_get_dap__Tz26__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_get_type(uvmt_fifo_tb__Syms* __restrict vlSymsp, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_object_registry__Tz81> &get_type__Vfuncrtn);
};
...
class uvmt_fifo_tb_uvm_pkg__03a__03auvm_set_before_get_dap__Tz26 : public uvmt_fifo_tb_uvm_pkg__03a__03auvm_set_get_dap_base__Tz26 {
  public:

    // DESIGN SPECIFIC STATE
    CData/*0:0*/ __PVT__m_set;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03am_uvm_tr_stream_cfg> __PVT__m_value;
  ...
  public:
    uvmt_fifo_tb_uvm_pkg__03a__03auvm_set_before_get_dap__Tz26(VlProcessRef vlProcess, uvmt_fifo_tb__Syms* __restrict vlSymsp, std::string name);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~uvmt_fifo_tb_uvm_pkg__03a__03auvm_set_before_get_dap__Tz26();
};
