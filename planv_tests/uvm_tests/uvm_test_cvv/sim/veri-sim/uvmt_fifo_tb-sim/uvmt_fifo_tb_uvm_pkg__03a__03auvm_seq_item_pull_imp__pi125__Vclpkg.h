...
#ifndef VERILATED_UVMT_FIFO_TB_UVM_PKG__03A__03AUVM_SEQ_ITEM_PULL_IMP__PI125__VCLPKG_H_
#define VERILATED_UVMT_FIFO_TB_UVM_PKG__03A__03AUVM_SEQ_ITEM_PULL_IMP__PI125__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) uvmt_fifo_tb_uvm_pkg__03a__03auvm_seq_item_pull_imp__pi125__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    uvmt_fifo_tb_uvm_pkg__03a__03auvm_seq_item_pull_imp__pi125__Vclpkg();
    ~uvmt_fifo_tb_uvm_pkg__03a__03auvm_seq_item_pull_imp__pi125__Vclpkg();
    void ctor(uvmt_fifo_tb__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(uvmt_fifo_tb_uvm_pkg__03a__03auvm_seq_item_pull_imp__pi125__Vclpkg);
...
class uvmt_fifo_tb_uvm_pkg__03a__03auvm_seq_item_pull_imp__pi125 : public uvmt_fifo_tb_uvm_pkg__03a__03auvm_port_base__Tz235 {
  public:

    // DESIGN SPECIFIC STATE
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_sequencer__Tz155_TBz155> __PVT__m_imp;
  ...
  public:
    uvmt_fifo_tb_uvm_pkg__03a__03auvm_seq_item_pull_imp__pi125(VlProcessRef vlProcess, uvmt_fifo_tb__Syms* __restrict vlSymsp, std::string name, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_sequencer__Tz155_TBz155> imp);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~uvmt_fifo_tb_uvm_pkg__03a__03auvm_seq_item_pull_imp__pi125();
};
