...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_comparer__Vclpkg::__VnoInFunc_get_type(uvmt_fifo_tb__Syms* __restrict vlSymsp, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_object_registry__pi11> &get_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  uvmt_fifo_tb_uvm_pkg__03a__03auvm_comparer__Vclpkg::__VnoInFunc_get_type\n"); );
    // Locals
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_object_registry__pi11> __Vfunc_get__0__Vfuncout;
    // Body
    vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__pi11__Vclpkg.__VnoInFunc_get(vlSymsp, __Vfunc_get__0__Vfuncout);
    get_type__Vfuncrtn = __Vfunc_get__0__Vfuncout;
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_comparer__Vclpkg::__VnoInFunc_type_name(uvmt_fifo_tb__Syms* __restrict vlSymsp, std::string &type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  uvmt_fifo_tb_uvm_pkg__03a__03auvm_comparer__Vclpkg::__VnoInFunc_type_name\n"); );
    // Body
    type_name__Vfuncrtn = "uvm_comparer"s;
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_comparer__Vclpkg::__VnoInFunc_set_default(uvmt_fifo_tb__Syms* __restrict vlSymsp, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_comparer> comparer) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  uvmt_fifo_tb_uvm_pkg__03a__03auvm_comparer__Vclpkg::__VnoInFunc_set_default\n"); );
    // Locals
    ...
    VL_NULL_CHECK(coreservice, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_comparer.svh", 234)->__VnoInFunc_set_default_comparer(vlSymsp, comparer);
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_comparer__Vclpkg::__VnoInFunc_get_default(uvmt_fifo_tb__Syms* __restrict vlSymsp, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_comparer> &get_default__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  uvmt_fifo_tb_uvm_pkg__03a__03auvm_comparer__Vclpkg::__VnoInFunc_get_default\n"); );
    // Locals
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__3__Vfuncout;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_comparer> __Vtask_get_default_comparer__4__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_coreservice_t> coreservice;
    ...
    VL_NULL_CHECK(coreservice, "/home/yilou/Desktop/OSVISE/planvtech/PlanV_Verilator_Feature_Tests/planv_tests/uvm_tests/uvm_test_cvv/sim/veri-sim/../../../../../uvm_lib/uvm-antmicro-deprecatedApi/src/base/uvm_comparer.svh", 241)->__VnoInFunc_get_default_comparer(vlSymsp, __Vtask_get_default_comparer__4__Vfuncout);
...
std::string VL_TO_STRING(const uvmt_fifo_tb_state_info_t__struct__0& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  uvmt_fifo_tb_uvm_pkg__03a__03auvm_comparer__Vclpkg::VL_TO_STRING\n"); );
    // Body
    std::string out;
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_comparer::__VnoInFunc_get_object_type(VlProcessRef vlProcess, uvmt_fifo_tb__Syms* __restrict vlSymsp, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_object_wrapper> &get_object_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_comparer::__VnoInFunc_get_object_type\n"); );
    // Locals
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_object_registry__pi11> __Vfunc_get__0__Vfuncout;
    // Body
    vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__pi11__Vclpkg.__VnoInFunc_get(vlSymsp, __Vfunc_get__0__Vfuncout);
...
void uvmt_fifo_tb_uvm_pkg__03a__03auvm_comparer::__VnoInFunc_create(VlProcessRef vlProcess, uvmt_fifo_tb__Syms* __restrict vlSymsp, std::string name, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_object> &create__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_comparer::__VnoInFunc_create\n"); );
    // Body
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_comparer> tmp;
    tmp = ((""s == name) ? VL_NEW(uvmt_fifo_tb_uvm_pkg__03a__03auvm_comparer, vlProcess, vlSymsp, ""s)
            : VL_NEW(uvmt_fifo_tb_uvm_pkg__03a__03auvm_comparer, vlProcess, vlSymsp, name));
    create__Vfuncrtn = tmp;
}

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_comparer::__VnoInFunc_get_type_name(uvmt_fifo_tb__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_comparer::__VnoInFunc_get_type_name\n"); );
    // Body
    get_type_name__Vfuncrtn = "uvm_comparer"s;
}

uvmt_fifo_tb_uvm_pkg__03a__03auvm_comparer::uvmt_fifo_tb_uvm_pkg__03a__03auvm_comparer(VlProcessRef vlProcess, uvmt_fifo_tb__Syms* __restrict vlSymsp, std::string name)
    : uvmt_fifo_tb_uvm_pkg__03a__03auvm_policy(vlProcess, vlSymsp, name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_comparer::new\n"); );
    // Body
...
extern const VlWide<128>/*4095:0*/ uvmt_fifo_tb__ConstPool__CONST_h8cd26482_0;

void uvmt_fifo_tb_uvm_pkg__03a__03auvm_comparer::__VnoInFunc_compare_field(uvmt_fifo_tb__Syms* __restrict vlSymsp, std::string name, VlWide<128>/*4095:0*/ lhs, VlWide<128>/*4095:0*/ rhs, IData/*31:0*/ size, IData/*27:0*/ radix, CData/*0:0*/ &compare_field__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                uvmt_fifo_tb_uvm_pkg__03a__03auvm_comparer::__VnoInFunc_compare_field\n"); );
    // Locals
    ...
    IData/*31:0*/ __Vdeeptemp_hcaa20751__0;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    ...
    std::string msg;
    {
        ...
        while ((__Vilp1 <= 0x0000007fU)) {
            mask[__Vilp1] = uvmt_fifo_tb__ConstPool__CONST_h8cd26482_0[__Vilp1];
        ...
        __Vdeeptemp_hcaa20751__0 = ((((((((((((((((
                                    ...
                                    | ((lhs[0x00000075U] 
                                       ...
                                       ^ (rhs[0x00000075U] 
                                          & mask[0x00000075U])));
        if ((0U != ((((((((((__Vdeeptemp_hcaa20751__0 
                             | ((lhs[0x00000076U] & 
                                 mask[0x00000076U]) 
                                ^ (rhs[0x00000076U] 
                                   & mask[0x00000076U]))) 
