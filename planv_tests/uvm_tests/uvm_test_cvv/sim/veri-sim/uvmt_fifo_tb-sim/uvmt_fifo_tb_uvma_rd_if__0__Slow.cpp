...
VL_ATTR_COLD void uvmt_fifo_tb_uvma_rd_if___ctor_var_reset(uvmt_fifo_tb_uvma_rd_if* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                                              uvmt_fifo_tb_uvma_rd_if___ctor_var_reset\n"); );
