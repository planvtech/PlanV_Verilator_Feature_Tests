...
#ifndef VERILATED_UVMT_FIFO_TB_UVM_PKG__03A__03AUVM_TLM_FIFO_BASE__TZ34__VCLPKG_H_
#define VERILATED_UVMT_FIFO_TB_UVM_PKG__03A__03AUVM_TLM_FIFO_BASE__TZ34__VCLPKG_H_  // guard

#include "verilated.h"
#include "verilated_timing.h"
#include "verilated_random.h"
class uvmt_fifo_tb_uvm_pkg__03a__03auvm_abstract_component_registry__pi165;
class uvmt_fifo_tb_uvm_pkg__03a__03auvm_analysis_port__Tz34;
class uvmt_fifo_tb_uvm_pkg__03a__03auvm_component;
class uvmt_fifo_tb_uvm_pkg__03a__03auvm_get_peek_imp__Tz34_TBz290;
class uvmt_fifo_tb_uvm_pkg__03a__03auvm_object_wrapper;
class uvmt_fifo_tb_uvm_pkg__03a__03auvm_put_imp__Tz34_TBz290;
...
class alignas(VL_CACHE_LINE_BYTES) uvmt_fifo_tb_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz34__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    uvmt_fifo_tb_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz34__Vclpkg();
    ~uvmt_fifo_tb_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz34__Vclpkg();
    void ctor(uvmt_fifo_tb__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(uvmt_fifo_tb_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz34__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_get_type(uvmt_fifo_tb__Syms* __restrict vlSymsp, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_abstract_component_registry__pi165> &get_type__Vfuncrtn);
};
...
class uvmt_fifo_tb_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz34 : public uvmt_fifo_tb_uvm_pkg__03a__03auvm_component {
  public:

    // DESIGN SPECIFIC STATE
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_put_imp__Tz34_TBz290> __PVT__put_export;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_get_peek_imp__Tz34_TBz290> __PVT__get_peek_export;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_analysis_port__Tz34> __PVT__put_ap;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_analysis_port__Tz34> __PVT__get_ap;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_put_imp__Tz34_TBz290> __PVT__blocking_put_export;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_put_imp__Tz34_TBz290> __PVT__nonblocking_put_export;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_get_peek_imp__Tz34_TBz290> __PVT__blocking_get_export;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_get_peek_imp__Tz34_TBz290> __PVT__nonblocking_get_export;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_get_peek_imp__Tz34_TBz290> __PVT__get_export;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_get_peek_imp__Tz34_TBz290> __PVT__blocking_peek_export;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_get_peek_imp__Tz34_TBz290> __PVT__nonblocking_peek_export;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_get_peek_imp__Tz34_TBz290> __PVT__peek_export;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_get_peek_imp__Tz34_TBz290> __PVT__blocking_get_peek_export;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_get_peek_imp__Tz34_TBz290> __PVT__nonblocking_get_peek_export;
  ...
  public:
    uvmt_fifo_tb_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz34(VlProcessRef vlProcess, uvmt_fifo_tb__Syms* __restrict vlSymsp, std::string name, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_component> parent);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~uvmt_fifo_tb_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz34();
};
