...
#ifndef VERILATED_UVMT_FIFO_TB_UVM_PKG__03A__03AUVM_TYPED_CALLBACKS__TZ329__VCLPKG_H_
#define VERILATED_UVMT_FIFO_TB_UVM_PKG__03A__03AUVM_TYPED_CALLBACKS__TZ329__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) uvmt_fifo_tb_uvm_pkg__03a__03auvm_typed_callbacks__Tz329__Vclpkg final {
  public:

    // DESIGN SPECIFIC STATE
    std::string __PVT__m_typename;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_queue__Tz55> __PVT__m_tw_cb_q;
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_typed_callbacks__Tz329> __PVT__m_t_inst;
    ...
    // CONSTRUCTORS
    uvmt_fifo_tb_uvm_pkg__03a__03auvm_typed_callbacks__Tz329__Vclpkg();
    ~uvmt_fifo_tb_uvm_pkg__03a__03auvm_typed_callbacks__Tz329__Vclpkg();
    void ctor(uvmt_fifo_tb__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(uvmt_fifo_tb_uvm_pkg__03a__03auvm_typed_callbacks__Tz329__Vclpkg);
    ...
    void __VnoInFunc_m_initialize(VlProcessRef vlProcess, uvmt_fifo_tb__Syms* __restrict vlSymsp, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_typed_callbacks__Tz329> &m_initialize__Vfuncrtn);
};
...
class uvmt_fifo_tb_uvm_pkg__03a__03auvm_typed_callbacks__Tz329 : public uvmt_fifo_tb_uvm_pkg__03a__03auvm_callbacks_base {
  public:
  ...
  public:
    uvmt_fifo_tb_uvm_pkg__03a__03auvm_typed_callbacks__Tz329(VlProcessRef vlProcess, uvmt_fifo_tb__Syms* __restrict vlSymsp);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~uvmt_fifo_tb_uvm_pkg__03a__03auvm_typed_callbacks__Tz329();
};
