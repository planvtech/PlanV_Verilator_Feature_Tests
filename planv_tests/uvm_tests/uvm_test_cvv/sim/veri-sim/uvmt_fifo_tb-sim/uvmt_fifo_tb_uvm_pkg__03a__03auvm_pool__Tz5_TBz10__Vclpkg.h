...
#ifndef VERILATED_UVMT_FIFO_TB_UVM_PKG__03A__03AUVM_POOL__TZ5_TBZ10__VCLPKG_H_
#define VERILATED_UVMT_FIFO_TB_UVM_PKG__03A__03AUVM_POOL__TZ5_TBZ10__VCLPKG_H_  // guard
...
class uvmt_fifo_tb_uvm_pkg__03a__03auvm_object_registry__Tz60;
class uvmt_fifo_tb_uvm_pkg__03a__03auvm_object_wrapper;
class uvmt_fifo_tb_uvm_pkg__03a__03auvm_pool__Tz5_TBz10;
...
class alignas(VL_CACHE_LINE_BYTES) uvmt_fifo_tb_uvm_pkg__03a__03auvm_pool__Tz5_TBz10__Vclpkg final {
  public:

    // DESIGN SPECIFIC STATE
    VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_pool__Tz5_TBz10> __PVT__m_global_pool;
    ...
    // CONSTRUCTORS
    uvmt_fifo_tb_uvm_pkg__03a__03auvm_pool__Tz5_TBz10__Vclpkg();
    ~uvmt_fifo_tb_uvm_pkg__03a__03auvm_pool__Tz5_TBz10__Vclpkg();
    void ctor(uvmt_fifo_tb__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(uvmt_fifo_tb_uvm_pkg__03a__03auvm_pool__Tz5_TBz10__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_get_global(uvmt_fifo_tb__Syms* __restrict vlSymsp, std::string key, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_resource__Tz3> &get_global__Vfuncrtn);
    void __VnoInFunc_get_global_pool(uvmt_fifo_tb__Syms* __restrict vlSymsp, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_pool__Tz5_TBz10> &get_global_pool__Vfuncrtn);
    void __VnoInFunc_get_type(uvmt_fifo_tb__Syms* __restrict vlSymsp, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_object_registry__Tz60> &get_type__Vfuncrtn);
...
class uvmt_fifo_tb_uvm_pkg__03a__03auvm_pool__Tz5_TBz10 : public uvmt_fifo_tb_uvm_pkg__03a__03auvm_object {
  public:

    // DESIGN SPECIFIC STATE
    VlAssocArray<std::string, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_resource__Tz3>> __PVT__pool;
    virtual void __VnoInFunc___VBasicRand(uvmt_fifo_tb__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn);
    virtual void __VnoInFunc___Vsetup_constraints(uvmt_fifo_tb__Syms* __restrict vlSymsp);
    virtual void __VnoInFunc_add(uvmt_fifo_tb__Syms* __restrict vlSymsp, std::string key, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_resource__Tz3> item);
    ...
    virtual void __VnoInFunc_get(uvmt_fifo_tb__Syms* __restrict vlSymsp, std::string key, VlClassRef<uvmt_fifo_tb_uvm_pkg__03a__03auvm_resource__Tz3> &get__Vfuncrtn);
  ...
  public:
    uvmt_fifo_tb_uvm_pkg__03a__03auvm_pool__Tz5_TBz10(VlProcessRef vlProcess, uvmt_fifo_tb__Syms* __restrict vlSymsp, std::string name);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~uvmt_fifo_tb_uvm_pkg__03a__03auvm_pool__Tz5_TBz10();
};
